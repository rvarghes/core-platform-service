...
import com.kcdata.abe.application.command.handler.SaveItineraryCommandHandler;
...
public class TestSaveItineraryCommandHandler {
	
	@Autowired
	private SaveItineraryCommandHandler saveItineraryCommandHandler;
	...
	public void saveItineraryChanges() {
		...
		retrieveBookingCommand.setBookingNo("0050013398");
		...
		itinerary.setBookingNo("");
		itinerary.setQuoteNo("");
		itinerary.setBookingHeader(null);
		SaveItineraryCommand saveItineraryCommand = new SaveItineraryCommand();
		saveItineraryCommand.setItinerary(itinerary);
		saveItineraryCommand.setIMApplicationInfo(applicationInfo);
		saveItineraryCommand = (SaveItineraryCommand)saveItineraryCommandHandler
											.handle(saveItineraryCommand);
		
		assertNotNull(saveItineraryCommand.getItinerary());
	}
