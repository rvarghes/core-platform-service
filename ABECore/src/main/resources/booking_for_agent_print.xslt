									...
									<tbody>
										<tr style="height:69px; ">
											<td style="width:225px; ">
												...
												<xsl:value-of select="Itinerary/bookingHeader/agency/customerNo"/>
												<br/>
													...
													<tbody>
														<tr>
															<td style="width:108px; ">
																<span>
																	<xsl:text>Royalties Number</xsl:text>
																</span>
															</td>
															<td style="width:10px; ">
																<span>
															...
															<td style="width:107px; ">
																<xsl:value-of select="Itinerary/imApplicationInfo/selectedAgent/royaltyNo"/>
															</td>
														</tr>
														<tr>
															<td style="width:108px; ">
...
<!-- 							<xsl:if test="not($promoId = '')"> 
				...
				<xsl:if test="$hotelsExists='true'">
					...
					<table border="0" cellPadding="2" style="font-size:12px" cellSpacing="2" width="675">
						<tbody>
							<tr style="background-color:#cacaca; font-weight:bold; ">
									...
									<tbody>
											...
											<td rowspan="6" style="width:451px; ">
												<table style="background-color:#f5f5f5; border-bottom:#a0a0a4 1px solid; border-left:#a0a0a4 1px solid; border-right:#a0a0a4 1px solid; border-top:#a0a0a4 1px solid; font-size:12px; " align="center" border="0" cellPadding="2" cellSpacing="2" width="320">
													...
													<tbody>
														...
														<xsl:when test="/Itinerary/bookingHeader/amountDue != '0.0'">														
															<tr style="font-weight:bold; ">
															...
															<tr style="font-weight:bold; ">
																<td style="width:180px; ">
																	<span>
																		<xsl:text>Net Balance Due </xsl:text> <!-- CQ#8955 - Rename Balance Due to Net Balance Due -->
																	</span>
																</td>
																<td style="width:8px; ">
																	<span>
																...
																<td style="width:110px; ">
																	...
																	<xsl:call-template name="format-price">
																		<xsl:with-param name="price">
																			<xsl:value-of select="/Itinerary/bookingHeader/amountDue"/>
																		</xsl:with-param>
																	</xsl:call-template>																
																</td>
															</tr>
															<tr style="font-weight:bold;">
																<td style="width:180px; ">
																	<span>
																		<xsl:text>Gross Balance Due</xsl:text><!-- CQ#8955 - Added  Gross Balance Due -->
																	</span>
																</td>
																<td style="width:8px; ">
																	<span>
																...
																<td style="width:110px; ">
																	...
																	<xsl:call-template name="format-price">
																		<xsl:with-param name="price">
																			<xsl:value-of select="/Itinerary/bookingHeader/grossBalanceDue"/>
																		</xsl:with-param>
																	</xsl:call-template>																
																</td>
															</tr>	
										...
										<tr>
											...
											<td style="width:128px; ">
												...
												<xsl:call-template name="format-price">
													<xsl:with-param name="price">
														<xsl:value-of select="/Itinerary/bookingHeader/netTotal"/>
													</xsl:with-param>
												</xsl:call-template>																
											</td>
										</tr>
										...
										<tr>
											...
											<td style="width:151px; ">
												<span>
													<xsl:text>Net Balance Due</xsl:text>
												</span>
											</td>
											<td style="width:10px; ">
												<span>
									...
									<tbody>
										<tr style="height:139px; ">
											<td>
												...
												<br/>
												<span>
													<xsl:text>Susquehanna Patriot Bank Apple Vacations Escrow</xsl:text>
												</span>
												<br/>
												<br/>
												<span style="font-weight:bold; ">
													<xsl:text>PLEASE REMIT PAYMENT TO :</xsl:text>
												</span>
												<br/>
												<span>
													<xsl:text>Apple Vacations, P.O. Box 6500, 7 Campus Blvd., Newtown Square PA 19073 or call 1-800-727-3400.</xsl:text>
												</span>
												<br/>
												<br/>
												<span>
													<xsl:text>If payment is made by check please include the Booking Number on the check. Gross amount is due on credit card payments.</xsl:text>
												</span>
												<br/>
												<span>
													<xsl:text>Please apply your payment through Apple On Line or call the Reservations Dept. at 800-365-2775. If you are submitting an agency check, please remit payment to address above AFTER entering information in the booking.</xsl:text>
												</span>
												<br/>
											</td>
										</tr>
								...
								<table border="0" style="font-size:12px" cellPadding="2" cellSpacing="2" width="675">
									<tbody>
										<tr style="height:49px; ">
											<td>
												<span style="font-weight:bold; ">
													<xsl:text>ALL FED-EX AND OTHER EXPRESS SERVICE deliveries, vacation certificates, discount coupons, bonus coupons, and other non check payment items must be sent directly to:</xsl:text>
												</span>
												<br/>
												<span>
													<xsl:text>Apple Vacations, 7 Campus Blvd., Newtown Square PA 19073</xsl:text>
												</span>
												<br/>
												<span>
													<xsl:text>Please do not send coupons or certificates to our bank.</xsl:text>
												</span>
											</td>
										</tr>
									</tbody>
