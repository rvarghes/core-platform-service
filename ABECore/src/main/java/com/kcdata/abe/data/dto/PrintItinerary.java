 ...
 * @since
 */
public class PrintItinerary implements ABEDto{
	/**
	 * 
	 */
	...
	private List<RequestedDatesForAvailability> reqDatesForAvl;
	private String rfaFromEmailAddress;
	private String rfaFromFaxNumber;
	private List<SeatAllocations> seatAllocationsList;
	...
	/**
	 * @return the rfaFromEmailAddress
	 */
	public String getRfaFromEmailAddress() {
		return rfaFromEmailAddress;
	}
	/**
	 * @param rfaFromEmailAddress the rfaFromEmailAddress to set
	 */
	public void setRfaFromEmailAddress(String rfaFromEmailAddress) {
		this.rfaFromEmailAddress = rfaFromEmailAddress;
	}
	/**
	 * @return the rfaFromFaxNumber
	 */
	public String getRfaFromFaxNumber() {
		return rfaFromFaxNumber;
	}
	/**
	 * @param rfaFromFaxNumber the rfaFromFaxNumber to set
	 */
	public void setRfaFromFaxNumber(String rfaFromFaxNumber) {
		this.rfaFromFaxNumber = rfaFromFaxNumber;
	}
	/**
	...
	/**
	 * @return the seatAllocations
	 */
	public List<SeatAllocations> getSeatAllocations() {
		return seatAllocationsList;
	}
	/**
	 * @param seatAllocations the seatAllocations to set
	 */
	public void setSeatAllocations(List<SeatAllocations> seatAllocations) {
		this.seatAllocationsList = seatAllocations;
	}
	/**
	...
	public Object clone() throws CloneNotSupportedException {
		PrintItinerary itinerary = (PrintItinerary) super.clone();
	...
	public void writeExternal(ObjectOutput out) throws IOException {
		...
		out.writeObject(reqDatesForAvl);
		out.writeObject(rfaFromEmailAddress);
		out.writeObject(rfaFromFaxNumber);
		out.writeObject(seatAllocationsList);
	...
	public void readExternal(ObjectInput in) throws IOException,
		...
		reqDatesForAvl =(List<RequestedDatesForAvailability>)in.readObject();
		rfaFromEmailAddress=(String)in.readObject();
		rfaFromFaxNumber=(String)in.readObject();
		seatAllocationsList=(List<SeatAllocations>)in.readObject();
	}
	/**
	 * @param reqDatesForAvl the reqDatesForAvl to set
	 */
	public void setReqDatesForAvl(List<RequestedDatesForAvailability> reqDatesForAvl) {
		this.reqDatesForAvl = reqDatesForAvl;
	}
	/**
	 * @return the reqDatesForAvl
	 */
	public List<RequestedDatesForAvailability> getReqDatesForAvl() {
		return reqDatesForAvl;
	}
