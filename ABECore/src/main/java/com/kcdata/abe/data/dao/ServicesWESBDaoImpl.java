...
import com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.imapplicationinfo.v1.IMApplicationInfo;
...
import com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.suppservicegroup.v1.SuppServiceGroup;
...
import com.kcdataservices.partners.kcdebsrvlib_hotel.businessobjects.hotelssupplementsdetailsresponse.v1.HotelsSupplementsDetailsResponse;
import com.kcdataservices.partners.kcdebsrvlib_hotel.businessobjects.hotelssupplementsrequest.v1.HotelsSupplementsRequest;
import com.kcdataservices.partners.kcdebsrvlib_hotel.businessobjects.hotelssupplementsresponse.v1.HotelsSupplementsResponse;
import com.kcdataservices.partners.kcdebsrvlib_hotel.interfaces.hotelservicebs.v1.RetrieveHotelSupplementsRetrieveHotelSupplementsFaultMsg;

/**
 * WESB Services DAO implementation class
 * 
 * @author vhalaki
 * 
 */
public class ServicesWESBDaoImpl extends ABESAPDaoBase implements
		WesbServicesDao {
	...
	org.apache.log4j.Logger logger = org.apache.log4j.Logger
			.getLogger(ServicesWESBDaoImpl.class);
	...
	public Date dateConverterXMLtoUtilDate(XMLGregorianCalendar xmlDate) {
	 ...
	 */
	public XMLGregorianCalendar dateConverter(Date date) {
	 ...
	 * 
	 */
	public com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.requesteddatesforavailability.v1.RequestedDatesForAvailability getRequestedDatesForAvailibilityBO(
			RequestedDatesForAvailability requestedDateDTO) {
		...
		requestedDatesForAvailabilityBO.setBookingDate(requestedDateDTO
				.getBookingDate());
		requestedDatesForAvailabilityBO.setBookingDuration(requestedDateDTO
				.getBookingDuration());
		requestedDatesForAvailabilityBO.setMaterialNumber(requestedDateDTO
				.getMaterialNumber());
		requestedDatesForAvailabilityBO.setNoOfRooms(requestedDateDTO
				.getNoOfRooms());
		requestedDatesForAvailabilityBO.setRoomDescription(requestedDateDTO
				.getRoomDescription());
		requestedDatesForAvailabilityBO.setRoomStatus(requestedDateDTO
				.getRoomStatus());
			...
			for (int i = 0; i < requestedDateDTO.getReqDates().size(); i++) {
				if (requestedDateDTO.getReqDates().get(i) != null) {
					if (requestedDatesForAvailabilityBO != null) {
						requestedDatesForAvailabilityBO.getReqDates().add(i,
								requestedDateDTO.getReqDates().get(i));
					}
				}
			}
		}
	 ...
	 * 
	 */
	public com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.roomprice.v1.RoomPrice getRoomPriceBO(
			RoomPrice roomPriceDTO) {
		com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.roomprice.v1.RoomPrice roomPriceBO = new com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.roomprice.v1.RoomPrice();
		...
		com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.roomprice.v1.RoomPrice internalRoomPriceBO = new com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.roomprice.v1.RoomPrice();
		...
		if (roomPriceDTO.getPaxBasePrices() != null) {
			paxTypeBasePricesBO.setAdultBasePrice(roomPriceDTO
					.getPaxBasePrices().getAdultBasePrice());
			paxTypeBasePricesBO.setChild1Age(roomPriceDTO.getPaxBasePrices()
					.getChild1Age());
			paxTypeBasePricesBO.setChild1Type(roomPriceDTO.getPaxBasePrices()
					.getChild1Type());
			paxTypeBasePricesBO.setChild2Age(roomPriceDTO.getPaxBasePrices()
					.getChild2Age());
			paxTypeBasePricesBO.setChild2Type(roomPriceDTO.getPaxBasePrices()
					.getChild2Type());
			paxTypeBasePricesBO.setChild3Age(roomPriceDTO.getPaxBasePrices()
					.getChild3Age());
			paxTypeBasePricesBO.setChild3Type(roomPriceDTO.getPaxBasePrices()
					.getChild3Type());
			paxTypeBasePricesBO.setChild4Type(roomPriceDTO.getPaxBasePrices()
					.getChild4Type());
			paxTypeBasePricesBO.setChild4Age(roomPriceDTO.getPaxBasePrices()
					.getChild4Age());
			paxTypeBasePricesBO.setChild5Age(roomPriceDTO.getPaxBasePrices()
					.getChild5Age());
			paxTypeBasePricesBO.setChild5Type(roomPriceDTO.getPaxBasePrices()
					.getChild5Type());
			paxTypeBasePricesBO.setChild6Age(roomPriceDTO.getPaxBasePrices()
					.getChild6Age());
			paxTypeBasePricesBO.setChild6Type(roomPriceDTO.getPaxBasePrices()
					.getChild6Type());
			paxTypeBasePricesBO.setChildBasePrice(roomPriceDTO
					.getPaxBasePrices().getChildBasePrice());
			paxTypeBasePricesBO.setInfantBasePrice(roomPriceDTO
					.getPaxBasePrices().getInfantBasePrice());
			paxTypeBasePricesBO.setJuniorBasePrice(roomPriceDTO
					.getPaxBasePrices().getJuniorBasePrice());
			paxTypeBasePricesBO.setLapChildBasePrice(roomPriceDTO
					.getPaxBasePrices().getLapChildBasePrice());
			paxTypeBasePricesBO.setMinorBasePrice(roomPriceDTO
					.getPaxBasePrices().getMinorBasePrice());
			paxTypeBasePricesBO.setNoOfAdults(roomPriceDTO.getPaxBasePrices()
					.getNoOfAdults());
			paxTypeBasePricesBO.setNoOfChilds(roomPriceDTO.getPaxBasePrices()
					.getNoOfChilds());
			paxTypeBasePricesBO.setNoOfInfants(roomPriceDTO.getPaxBasePrices()
					.getNoOfInfants());
			paxTypeBasePricesBO.setNoOfJuniors(roomPriceDTO.getPaxBasePrices()
					.getNoOfJuniors());
			paxTypeBasePricesBO.setNoOfLapChilds(roomPriceDTO
					.getPaxBasePrices().getNoOfLapChilds());
			paxTypeBasePricesBO.setNoOfMinors(roomPriceDTO.getPaxBasePrices()
					.getNoOfMinors());
			paxTypeBasePricesBO.setNoOfSeniors(roomPriceDTO.getPaxBasePrices()
					.getNoOfSeniors());
		...
		if (roomPriceDTO.getPaxTypePriceBreakups() != null) {
			listOfPaxTypePriceBreakUpDTO = roomPriceDTO
					.getPaxTypePriceBreakups();
			for (int i = 0; i < listOfPaxTypePriceBreakUpDTO.size(); i++) {
				if (listOfPaxTypePriceBreakUpDTO.get(i) != null) {
					paxTypePriceBreakUpBO.setAge(listOfPaxTypePriceBreakUpDTO
							.get(i).getAge());
					paxTypePriceBreakUpBO
							.setAirportTax(listOfPaxTypePriceBreakUpDTO.get(i)
									.getAirportTax());
					paxTypePriceBreakUpBO.setCount(listOfPaxTypePriceBreakUpDTO
							.get(i).getCount());
					paxTypePriceBreakUpBO
							.setForeignTax(listOfPaxTypePriceBreakUpDTO.get(i)
									.getForeignTax());
					// paxTypePriceBreakUpBO.setLateFee(listOfPaxTypePriceBreakUpDTO.get(i).getLateFee());
					paxTypePriceBreakUpBO
							.setMaxAge(listOfPaxTypePriceBreakUpDTO.get(i)
									.getMaxAge());
					paxTypePriceBreakUpBO
							.setMinAge(listOfPaxTypePriceBreakUpDTO.get(i)
									.getMinAge());
					paxTypePriceBreakUpBO.setPaxType(Character
							.toString(listOfPaxTypePriceBreakUpDTO.get(i)
									.getPaxType()));
					paxTypePriceBreakUpBO.setPrice(listOfPaxTypePriceBreakUpDTO
							.get(i).getPrice());
					paxTypePriceBreakUpBO
							.setRoomId(listOfPaxTypePriceBreakUpDTO.get(i)
									.getRoomId());
					paxTypePriceBreakUpBO
							.setSavings(listOfPaxTypePriceBreakUpDTO.get(i)
									.getSavings());
					paxTypePriceBreakUpBO.setTaxes(listOfPaxTypePriceBreakUpDTO
							.get(i).getTaxes());
					paxTypePriceBreakUpBO
							.setTotalAmount(listOfPaxTypePriceBreakUpDTO.get(i)
									.getTotalAmount());
					paxTypePriceBreakUpBO
							.setTypeRule(listOfPaxTypePriceBreakUpDTO.get(i)
									.getTypeRule());
					paxTypePriceBreakUpBO.setUsTax(listOfPaxTypePriceBreakUpDTO
							.get(i).getUsTax());
					roomPriceBO.getPaxTypePriceBreakups().add(i,
							paxTypePriceBreakUpBO);
				}
			}
		}
		...
		if (roomPriceDTO.getInitialPrice() != null) {
			roomPriceBO.setInitialPrice(getInternalRoomPriceBO(roomPriceDTO
					.getInitialPrice()));
		}
	...
	/**
	 * Method to prepare inner initialRoomPrice which is inner RoomPrice object
	 * of RoomPrice BO
	 * 
	 * @param roomPriceDTO
	 * @return RoomPrice
	 * 
	 */
	public com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.roomprice.v1.RoomPrice getInternalRoomPriceBO(
			RoomPrice roomPriceDTO) {
			...
			for (int i = 0; i < listOfPaxTypePriceBreakUpDTO.size(); i++) {
				...
				paxTypePriceBreakUpBO
						.setForeignTax(listOfPaxTypePriceBreakUpDTO.get(i)
								.getForeignTax());
				// paxTypePriceBreakUpBO.setLateFee(listOfPaxTypePriceBreakUpDTO.get(i).getLateFee());
				paxTypePriceBreakUpBO.setMaxAge(listOfPaxTypePriceBreakUpDTO
						.get(i).getMaxAge());
				paxTypePriceBreakUpBO.setMinAge(listOfPaxTypePriceBreakUpDTO
						.get(i).getMinAge());
				paxTypePriceBreakUpBO.setPaxType(Character
						.toString(listOfPaxTypePriceBreakUpDTO.get(i)
								.getPaxType()));
				paxTypePriceBreakUpBO.setPrice(listOfPaxTypePriceBreakUpDTO
						.get(i).getPrice());
				paxTypePriceBreakUpBO.setRoomId(listOfPaxTypePriceBreakUpDTO
						.get(i).getRoomId());
				paxTypePriceBreakUpBO.setSavings(listOfPaxTypePriceBreakUpDTO
						.get(i).getSavings());
				paxTypePriceBreakUpBO.setTaxes(listOfPaxTypePriceBreakUpDTO
						.get(i).getTaxes());
				paxTypePriceBreakUpBO
						.setTotalAmount(listOfPaxTypePriceBreakUpDTO.get(i)
								.getTotalAmount());
				paxTypePriceBreakUpBO.setTypeRule(listOfPaxTypePriceBreakUpDTO
						.get(i).getTypeRule());
				paxTypePriceBreakUpBO.setUsTax(listOfPaxTypePriceBreakUpDTO
						.get(i).getUsTax());
				roomPriceBO.getPaxTypePriceBreakups().add(i,
	 ...
	 * @return Amenity
	 */
	public com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.amenity.v1.Amenity getAmenityBO(
			Amenity amenityDTO) {
		com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.amenity.v1.Amenity amenityBO = new com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.amenity.v1.Amenity();

		amenityBO.setAmenityCode(amenityDTO.getAmenityCode());
		if (amenityDTO.getAmenityDate() != null) {
			amenityBO
					.setAmenityDate(dateConverter(amenityDTO.getAmenityDate()));
		}
	 ...
	 * 
	 */
	public RoomCategory getRoomCategoryBO(
			com.kcdata.abe.data.dto.RoomCategory roomCategoryDTO) {
		...
		if(roomCategoryDTO.getDisplayRoomPrice()!=null)
		{
		roomCategoryBO.setDisplayRoomPrice(getRoomPriceBO(roomCategoryDTO
				.getDisplayRoomPrice()));
		}
		...
		roomCategoryBO.setGuaranteeRequired(roomCategoryDTO
		...
		if (roomCategoryDTO.getMealPlanType() != null) {
			...
			mealPlanTypeBO.setDescription(roomCategoryDTO.getMealPlanType()
					.getDescription());

		}

		roomCategoryBO.setMealPlanType(mealPlanTypeBO);
		roomCategoryBO.setNoOfRoomsAvailable(roomCategoryDTO
		...
		roomCategoryBO.setRatePlanCategory(roomCategoryDTO
				.getRatePlanCategory());
		roomCategoryBO.setRatePlanCode(roomCategoryDTO.getRatePlanCode());
		roomCategoryBO.setRatePlanDescription(roomCategoryDTO
				.getRatePlanDescription());
		roomCategoryBO.setRatePlanId(roomCategoryDTO.getRatePlanId());
		roomCategoryBO
				.setRiskRoomCategory(roomCategoryDTO.isRiskRoomCategory());
		...
		roomCategoryBO.setRoomTypeDescription(roomCategoryDTO
		...
		if (roomCategoryDTO.getRoomPrices() != null) {
			...
			for (int i = 0; i < roomCategoryDTO.getRoomPrices().size(); i++) {
				if (roomCategoryDTO.getRoomPrices().get(i) != null) {
					roomPriceBO = getRoomPriceBO(roomCategoryDTO
							.getRoomPrices().get(i));
	 ...
	 * @return AgeCode
	 */
	public AgeCode getAgeCodeBO(com.kcdata.abe.data.dto.AgeCode ageCodeDTO) {
		AgeCode ageCodeBO = new AgeCode();
		ageCodeBO.setAge(ageCodeDTO.getAgeCode());
		if (Character.toString(ageCodeDTO.getPaxTypeCode()) != null) {
			ageCodeBO.setPaxTypeCode(Character.toString(ageCodeDTO
					.getPaxTypeCode()));
		}
		return ageCodeBO;
	 ...
	 * 
	 */
	public Passenger getPassengerBO(
			com.kcdata.abe.data.dto.Passenger passengerDTO) {
	 ...
	 * @return Occupancy
	 */
	public com.kcdataservices.partners.kcdebdmnlib_common.businessobjects.occupancy.v1.Occupancy getOccuPancyBO(
			Occupancy occupancyDTO) {
		com.kcdataservices.partners.kcdebdmnlib_common.businessobjects.occupancy.v1.Occupancy occupancyBO = new com.kcdataservices.partners.kcdebdmnlib_common.businessobjects.occupancy.v1.Occupancy();
		...
		if (occupancyDTO.getPassengers() != null) {
			...
			for (int i = 0; i < occupancyDTO.getPassengers().size(); i++) {
				Passenger passengerBO = new Passenger();
				passengerBO = getPassengerBO(occupancyDTO.getPassengers()
						.get(i));
	 ...
	 * @return TimeOfDay
	 */
	public TimeOfDay getTimeOfDayBO(
			com.kcdata.abe.data.dto.TimeOfDay timeOfDayDTO) {
	 ...
	 * 
	 */
	public CabinType getCabinTypeBo(
			com.kcdata.abe.data.dto.CabinType cabinTypeDTO) {
	 ...
	 * @return AirOptions
	 */
	public com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.airoptions.v1.AirOptions getAirOptionsBO(
			AirOptions airOptionsDTO) {
		...
		if (airOptionsDTO.getDepartureTimeOfDay() != null) {
			airOptionsBO.setDepartureTimeOfDay(getTimeOfDayBO(airOptionsDTO
					.getDepartureTimeOfDay()));
		}
		if (airOptionsDTO.getArrivaTimeOfDay() != null) {
			airOptionsBO.setArrivaTimeOfDay(getTimeOfDayBO(airOptionsDTO
					.getArrivaTimeOfDay()));
		}
		if (airOptionsDTO.getCabinType() != null) {
			airOptionsBO.setCabinType(getCabinTypeBo(airOptionsDTO
					.getCabinType()));
		}
		return airOptionsBO;
	}
	 ...
	 */
	public com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.vehicleoptions.v1.VehicleOptions getVehicleOptionsBO(
			VehicleOptions vehicleOptionDTO) {
		com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.vehicleoptions.v1.VehicleOptions vehicleOptionsBO = new com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.vehicleoptions.v1.VehicleOptions();
		if (vehicleOptionDTO.getDropoffDateTime() != null) {
			vehicleOptionsBO.setDropoffDateTime(dateConverter(vehicleOptionDTO
					.getDropoffDateTime()));
		}
		vehicleOptionsBO.setDropoffLocation(vehicleOptionDTO
				.getDropoffLocation());
		if (vehicleOptionDTO.getPickupDateTime() != null) {
			vehicleOptionsBO.setPickupDateTime(dateConverter(vehicleOptionDTO
					.getPickupDateTime()));
		}
		vehicleOptionsBO
	 ...
	 * 
	 */
	public SpecialType getSpecialTypeBO(
	 ...
	 */
	public SpecialRequestType getSpecialRequestTypeBO(
	 ...
	 */
	public SpecialOptions getSpecialOptionsBO(
	 ...
	 * @return Carrier
	 */
	public Carrier getCarriersBO(com.kcdata.abe.data.dto.Carrier carrierDTO) {
	 ...
	 * 
	 */
	public ResortArea getResortAreaBO(
			com.kcdata.abe.data.dto.ResortArea resortAreaDTO) {
	...
	public IMApplicationInfo getImApplicationInfo() {
		...
		UserType userTypeBO = new UserType();
		userTypeBO.setCode(this.getApplicationContextFactory()
				.getApplicationContext().getRequestContext()
				.getIMApplicationInfo().getType().getCode());
		imApplicationInfo.setType(userTypeBO);// UserType
	 ...
	 * @return Address
	 */
	public Address getAddressBO(com.kcdata.abe.data.dto.Address addressDTO) {
	 ...
	 * @return PassportInfo
	 */
	public PassportInfo getPassportInfoBO(
			com.kcdata.abe.data.dto.PassportInfo passportInfoDTO) {
		PassportInfo passportInfoBO = new PassportInfo();
		if (passportInfoDTO.getAddress() != null) {
			passportInfoBO
					.setAddress(getAddressBO(passportInfoDTO.getAddress()));
		}
		passportInfoBO.setCountryOfIssue(passportInfoDTO.getCountryOfIssue());
		if (passportInfoDTO.getExpirationDate() != null) {
			passportInfoBO.setExpirationDate(dateConverter(passportInfoDTO
					.getExpirationDate()));
		}
	 ...
	 * @return GuestInfo
	 */
	public com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.guestinfo.v1.GuestInfo getGuestInfoBO(
			com.kcdata.abe.data.dto.GuestInfo guestInfoDTO) {
		...
		if (guestInfoDTO.getDateOfBirth() != null) {
			guestInfoBO.setDateOfBirth(dateConverter(guestInfoDTO
					.getDateOfBirth()));
		}
		guestInfoBO.setEmailId(guestInfoDTO.getEmailId());
		guestInfoBO.setEmergencyContactName(guestInfoDTO
				.getEmergencyContactName());
		guestInfoBO.setEmergencyContactPhone(guestInfoDTO
		...
		if (guestInfoDTO.getPassportInfo() != null) {
			guestInfoBO.setPassportInfo(getPassportInfoBO(guestInfoDTO
					.getPassportInfo()));
		}

		if (guestInfoDTO.getPriceBreakup() != null) {
			guestInfoBO.setPriceBreakup(getGuestPriceBreakupBO(guestInfoDTO
					.getPriceBreakup()));
		}
	 ...
	 * 
	 */
	public GuestPriceBreakup getGuestPriceBreakupBO(
			com.kcdata.abe.data.dto.GuestPriceBreakup guestPriceBreakupDTO)

	{
		...
		guestpriceBreakupBO.setFlightPrice(guestPriceBreakupDTO
				.getFlightPrice());
		guestpriceBreakupBO.setHotelPrice(guestPriceBreakupDTO.getHotelPrice());
		guestpriceBreakupBO.setInsurancePrice(guestPriceBreakupDTO
				.getInsurancePrice());
		guestpriceBreakupBO.setServicePrice(guestPriceBreakupDTO
				.getServicePrice());
		guestpriceBreakupBO.setSupplementsPrice(guestPriceBreakupDTO
				.getSupplementsPrice());
		...
		guestpriceBreakupBO.setVehiclePrice(guestPriceBreakupDTO
				.getVehiclePrice());
	 ...
	 * 
	 */
	public HotelOptions getHotelOptionsBO(
			com.kcdata.abe.data.dto.HotelOptions hotelOptionsDTO) {
		...
		if (hotelOptionsDTO.getResortArea() != null) {
			hotelOptionsBO.setResortArea(getResortAreaBO(hotelOptionsDTO
					.getResortArea()));
		}
		if (hotelOptionsDTO.getAmenities() != null) {
			for (int i = 0; i < hotelOptionsDTO.getAmenities().size(); i++) {
				hotelOptionsBO.getAmenities().add(i,
						getAmenityBO(hotelOptionsDTO.getAmenities().get(i)));
			}
		}
	...
	public com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.destinationoptions.v1.DestinationOptions getdestinationOptionsBO(
			DestinationOptions destinationOptionsDTO) {
		...
		destinationOptionsBO.setAirRequested(destinationOptionsDTO
				.isAirRequested());
		destinationOptionsBO.setAlternateGatewayMiles(destinationOptionsDTO
				.getAlternateGatewayMiles());
		destinationOptionsBO.setCharterOnly(destinationOptionsDTO
				.isCharterOnly());
		destinationOptionsBO.setDestination(destinationOptionsDTO
				.getDestination());
		destinationOptionsBO.setDestinationId(destinationOptionsDTO
				.getDestinationId());
		destinationOptionsBO.setDoubleConnections(destinationOptionsDTO
				.getDoubleConnections());
		destinationOptionsBO.setFlexiDateIndicator(destinationOptionsDTO
				.isFlexiDateIndicator());
		destinationOptionsBO.setHotelRequested(destinationOptionsDTO
				.isHotelRequested());
		destinationOptionsBO.setMultiCarrierFlights(destinationOptionsDTO
				.getMultiCarrierFlights());
		destinationOptionsBO.setNearbyAirportIndicator(destinationOptionsDTO
				.isNearbyAirportIndicator());
		destinationOptionsBO.setNonStopFlights(destinationOptionsDTO
				.getNonStopFlights());
		destinationOptionsBO.setNoOfAirOptions(destinationOptionsDTO
				.getNoOfAirOptions());
		destinationOptionsBO.setNoOfNights(destinationOptionsDTO
				.getNoOfNights());
		destinationOptionsBO.setSkedOnly(destinationOptionsDTO.isSkedOnly());
		destinationOptionsBO.setVehicleRequested(destinationOptionsDTO
				.isVehicleRequested());

		if (destinationOptionsDTO.getOutboundAirOptions() != null) {
			AirOptions outBoundAirOptionsDTO = destinationOptionsDTO
					.getOutboundAirOptions();
			com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.airoptions.v1.AirOptions outBoundAirOptionsBO = new com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.airoptions.v1.AirOptions();
			if (outBoundAirOptionsDTO != null) {
				outBoundAirOptionsBO = getAirOptionsBO(outBoundAirOptionsDTO);
				destinationOptionsBO
						.setOutboundAirOptions(outBoundAirOptionsBO);
			}
		}

		if (destinationOptionsDTO.getInboundAirOptions() != null) {
			destinationOptionsBO
					.setInboundAirOptions(getAirOptionsBO(destinationOptionsDTO
							.getInboundAirOptions()));
		}
		if (destinationOptionsDTO.getVehicleOptions() != null) {
			destinationOptionsBO
					.setVehicleOptions(getVehicleOptionsBO(destinationOptionsDTO
							.getVehicleOptions()));
		}
		if (destinationOptionsDTO.getSpecialOptions() != null) {
			destinationOptionsBO
					.setSpecialOptions(getSpecialOptionsBO(destinationOptionsDTO
							.getSpecialOptions()));
		}
		...
		if (destinationOptionsDTO.getPreferredCarriersList() != null) {
			for (int i = 0; i < destinationOptionsDTO
					.getPreferredCarriersList().size(); i++) {
				if (destinationOptionsDTO.getPreferredCarriersList().get(i) != null) {
					Carrier carrierBO = getCarriersBO(destinationOptionsDTO
							.getPreferredCarriersList().get(i));
					destinationOptionsBO.getPreferredCarriersList().add(i,
							carrierBO);
				}
			}
		}
		...
		if (destinationOptionsDTO.getNearByDestinations() != null) {
			for (int i = 0; i < destinationOptionsDTO.getNearByDestinations()
					.size(); i++) {
				destinationOptionsBO.getNearByDestinations().add(i,
						destinationOptionsDTO.getNearByDestinations().get(i));
			}
		...
		if (destinationOptionsDTO.getHotelOptions() != null) {
			destinationOptionsBO
					.setHotelOptions(getHotelOptionsBO(destinationOptionsDTO
							.getHotelOptions()));
		}
	 ...
	 * @return Hotel
	 */
	public com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.hotel.v1.Hotel getListOfHotels(
			com.kcdata.abe.data.dto.Hotel hotel) {
		...
		com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.searchcriteria.v1.SearchCriteria searchCriteriaBO = new com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.searchcriteria.v1.SearchCriteria();
		...
		if (hotel.getResortArea() != null) {
			resortAreaBO.setResortAreaCode(hotel.getResortArea()
					.getResortAreaCode());
			resortAreaBO.setResortAreaName(hotel.getResortArea()
					.getResortAreaName());
		...
		if (hotel.getVendor() != null) {
			...
			// need to check because vendorExist is boolean in ABE but in WESB
			// it is String
		...
		if (listOfVendorServiceDTO != null) {
			for (int i = 0; i < listOfVendorServiceDTO.size(); i++) {
				com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.vendorservice.v1.VendorService vendorSrviceBO = new com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.vendorservice.v1.VendorService();
				vendorSrviceBO.setCurrency(listOfVendorServiceDTO.get(i)
						.getCurrency());
				vendorSrviceBO.setPrice(listOfVendorServiceDTO.get(i)
						.getPrice());
				vendorSrviceBO.setServiceCode(listOfVendorServiceDTO.get(i)
						.getServiceCode());
				vendorSrviceBO.setServiceName(listOfVendorServiceDTO.get(i)
						.getServiceName());
				vendorSrviceBO.setVendorId(listOfVendorServiceDTO.get(i)
						.getVendorId());
		...
		if (hotel.getOccupancy() != null) {
			...
			occupancyBO.setNoOfLapChilds(hotel.getOccupancy()
					.getNoOfLapChilds());
			...
			if (hotel.getOccupancy().getPassengers() != null) {
				...
				if (listOfPassengersDTO != null) {
					for (int i = 0; i < listOfPassengersDTO.size(); i++) {
						...
						passengerBO.setGuestCount(listOfPassengersDTO.get(i)
								.getGuestCount());
						passengerBO.setPaxId(listOfPassengersDTO.get(i)
								.getPaxId());
						passengerBO.setRoomNumber(listOfPassengersDTO.get(i)
								.getRoomNumber());
						ageCodeBO.setAge(listOfPassengersDTO.get(i)
								.getAgeCode().getAgeCode());
		...
		if (hotel.getDisplayRoomCategory() != null) {
			displayRoomCategoryBO.setAppleChoice(hotel.getDisplayRoomCategory()
					.getAppleChoice());
			displayRoomCategoryBO.setCorporateId(hotel.getDisplayRoomCategory()
					.getCorporateId());
			displayRoomCategoryBO.setCurrency(hotel.getDisplayRoomCategory()
					.getCurrency());
			displayRoomCategoryBO.setGuaranteeAmount(hotel
					.getDisplayRoomCategory().getGuaranteeAmount());
			displayRoomCategoryBO.setGuaranteeMethod(hotel
					.getDisplayRoomCategory().getGuaranteeMethod());
			displayRoomCategoryBO.setGuaranteeRequired(hotel
					.getDisplayRoomCategory().getGuaranteeRequired());
			displayRoomCategoryBO.setGuaranteeType(hotel
					.getDisplayRoomCategory().getGuaranteeType());
			displayRoomCategoryBO.setHotelId(hotel.getDisplayRoomCategory()
					.getHotelId());
			displayRoomCategoryBO.setMealplanDesc(hotel
					.getDisplayRoomCategory().getMealplanDesc());
			displayRoomCategoryBO.setNoOfRoomsAvailable(hotel
					.getDisplayRoomCategory().getNoOfRoomsAvailable());
			displayRoomCategoryBO.setOldPosnr(hotel.getDisplayRoomCategory()
					.getOldPosnr());
			displayRoomCategoryBO.setPosnr(hotel.getDisplayRoomCategory()
					.getPosnr());
			displayRoomCategoryBO.setRateIndicator(hotel
					.getDisplayRoomCategory().getRateIndicator());
			displayRoomCategoryBO.setRatePlanCategory(hotel
					.getDisplayRoomCategory().getRatePlanCategory());
			displayRoomCategoryBO.setRatePlanCode(hotel
					.getDisplayRoomCategory().getRatePlanCode());
			displayRoomCategoryBO.setRatePlanDescription(hotel
					.getDisplayRoomCategory().getRatePlanDescription());
			displayRoomCategoryBO.setRatePlanId(hotel.getDisplayRoomCategory()
					.getRatePlanId());
			displayRoomCategoryBO.setRiskRoomCategory(hotel
					.getDisplayRoomCategory().isRiskRoomCategory());
			displayRoomCategoryBO.setRoomCategoryId(hotel
					.getDisplayRoomCategory().getRoomCategoryId());
			displayRoomCategoryBO.setRoomTypeCode(hotel
					.getDisplayRoomCategory().getRoomTypeCode());
			displayRoomCategoryBO.setRoomTypeDescription(hotel
					.getDisplayRoomCategory().getRoomTypeDescription());
			displayRoomCategoryBO.setStatus(hotel.getDisplayRoomCategory()
					.getStatus());
			...
			if (hotel.getDisplayRoomCategory().getRoomPrices() != null) {
				com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.roomprice.v1.RoomPrice displayRoomCategoryRoomPriceBO = new com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.roomprice.v1.RoomPrice();
				displayRoomCategoryRoomPriceDTO = hotel
						.getDisplayRoomCategory().getRoomPrices();

				if (displayRoomCategoryRoomPriceDTO != null) {
					for (int i = 0; i < displayRoomCategoryRoomPriceDTO.size(); i++) {
						displayRoomCategoryRoomPriceBO = getRoomPriceBO(displayRoomCategoryRoomPriceDTO
								.get(i));
						displayRoomCategoryBO.getRoomPrices().add(i,
								displayRoomCategoryRoomPriceBO);
					}
				}
			}
			...
			if (hotel.getDisplayRoomCategory().getDisplayRoomPrice() != null) {
				com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.roomprice.v1.RoomPrice displayRoomPriceBO = new com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.roomprice.v1.RoomPrice();
				displayRoomPriceBO = getRoomPriceBO(hotel
						.getDisplayRoomCategory().getDisplayRoomPrice());
			...
			if (hotel.getDisplayRoomCategory().getAmenities() != null) {
				listOfAmenitiesDTO = hotel.getDisplayRoomCategory()
						.getAmenities();
				com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.amenity.v1.Amenity amenityBO = new com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.amenity.v1.Amenity();
				for (int i = 0; i < hotel.getDisplayRoomCategory()
						.getAmenities().size(); i++) {
					amenityBO = getAmenityBO(hotel.getDisplayRoomCategory()
							.getAmenities().get(i));
			...
			if (hotel.getDisplayRoomCategory().getMealPlanType() != null) {
				MealPlanType mealPlanTypeBO = new MealPlanType();
				mealPlanTypeBO.setCode(hotel.getDisplayRoomCategory()
						.getMealPlanType().getCode());
				mealPlanTypeBO.setDescription(hotel.getDisplayRoomCategory()
		...
		if (hotel.getPreselectedRooms() != null) {
			...
			com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.roomprice.v1.RoomPrice preselectedRoomPriceBO = new com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.roomprice.v1.RoomPrice();
			for (int i = 0; i < roomPriceForPreselctedRoomsDTO.size(); i++) {
				preselectedRoomPriceBO = getRoomPriceBO(roomPriceForPreselctedRoomsDTO
						.get(i));
		...
		if (hotel.getSelectedRooms() != null) {
			...
			com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.roomprice.v1.RoomPrice selectedRoomPrice = new com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.roomprice.v1.RoomPrice();
			for (int i = 0; i < roomPriceForSelectedRoomsDTO.size(); i++) {
				selectedRoomPrice = getRoomPriceBO(hotel.getSelectedRooms()
						.get(i));
		...
		if (hotel.getRequestedDatesForAvailabilities() != null) {
			com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.requesteddatesforavailability.v1.RequestedDatesForAvailability requestedDatesforAvailibilityBO = new com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.requesteddatesforavailability.v1.RequestedDatesForAvailability();
			requestedDatesForAvailabilityDTO = hotel
			...
			for (int i = 0; i < requestedDatesForAvailabilityDTO.size(); i++) {
				if (requestedDatesForAvailabilityDTO.get(i) != null) {
					requestedDatesforAvailibilityBO = getRequestedDatesForAvailibilityBO(requestedDatesForAvailabilityDTO
							.get(i));
					hotelBO.getRequestedDatesForAvailabilities().add(i,
							requestedDatesforAvailibilityBO);
				}
			}
		}
		...
		if (hotel.getRoomCategories() != null) {
			...
			for (int i = 0; i < roomCategoriesListDTO.size(); i++) {
				roomcCategoryBO = getRoomCategoryBO(roomCategoriesListDTO
						.get(i));
		...
		if (hotel.getSearchCriteria() != null) {
			...
			if (searchCriteriaDTO.getAnchorDepartureDate() != null) {
				searchCriteriaBO
						.setAnchorDepartureDate(dateConverter(searchCriteriaDTO
								.getAnchorDepartureDate()));
			}
			searchCriteriaBO.setAnchorGateway(searchCriteriaDTO
					.getAnchorGateway());
			searchCriteriaBO.setBookingNo(searchCriteriaDTO.getBookingNo());
			if (searchCriteriaDTO.getDepartureDate() != null) {
				searchCriteriaBO
						.setDepartureDate(dateConverter(searchCriteriaDTO
								.getDepartureDate()));
			}
			searchCriteriaBO.setFilterSpecials(searchCriteriaDTO
					.isFilterSpecials());

			// Prepare FilterType
			if (searchCriteriaDTO.getFlightTripType() != null) {
				FlightTripType flightTripTypeBO = new FlightTripType();
				flightTripTypeBO.setType(searchCriteriaDTO.getFlightTripType()
						.getType());
			...
			if (hotel.getSearchCriteria().getOccupancy() != null) {
				com.kcdataservices.partners.kcdebdmnlib_common.businessobjects.occupancy.v1.Occupancy occupancyBOOfsearchCriteria = new com.kcdataservices.partners.kcdebdmnlib_common.businessobjects.occupancy.v1.Occupancy();

				occupancyBOOfsearchCriteria = getOccuPancyBO(hotel
						.getSearchCriteria().getOccupancy());
			...
			if (hotel.getSearchCriteria().getNearByGateways() != null) {
				for (int i = 0; i < hotel.getSearchCriteria()
						.getNearByGateways().size(); i++) {
					searchCriteriaBO.getNearByGateways().add(
							i,
							hotel.getSearchCriteria().getNearByGateways()
									.get(i));
				}
			}
			...
			if (hotel.getSearchCriteria().getDestinationOptions() != null) {
				List<DestinationOptions> destinationOptionsDTO = hotel
						.getSearchCriteria().getDestinationOptions();
				for (int i = 0; i < destinationOptionsDTO.size(); i++) {
					com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.destinationoptions.v1.DestinationOptions destinationOptionsBO = new com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.destinationoptions.v1.DestinationOptions();
					destinationOptionsBO = getdestinationOptionsBO(destinationOptionsDTO
							.get(i));
					searchCriteriaBO.getDestinationOptions().add(i,
							destinationOptionsBO);
				}
			}
	...
	public Service getServiceDTO(
		...
		serviceDTO.setAdultPrice(serviceBO.getAdultPrice());

		if (serviceBO.getAdultQty() != null) {
			serviceDTO.setAdultQty(serviceBO.getAdultQty().byteValue());
		}
		if (serviceBO.isAllOrNothing() != null) {
			serviceDTO.setAllOrNothing(serviceBO.isAllOrNothing()
					.booleanValue());
		}
		if (serviceBO.getChild1MaxAge() != null) {
			serviceDTO.setChild1MaxAge(serviceBO.getChild1MaxAge().byteValue());
		}
		if (serviceBO.getChild1MinAge() != null) {
			serviceDTO.setChild1MinAge(serviceBO.getChild1MinAge().byteValue());
		}
		if (serviceBO.getChild1Price() != null) {
			serviceDTO.setChild1Price(serviceBO.getChild1Price().doubleValue());
		}
		if (serviceBO.getChild1Qty() != null) {
			serviceDTO.setChild1Qty(serviceBO.getChild1Qty().byteValue());
		}
		if (serviceBO.getChild2MaxAge() != null) {
			serviceDTO.setChild2MaxAge(serviceBO.getChild2MaxAge().byteValue());
		}
		if (serviceBO.getChild2MinAge() != null) {
			serviceDTO.setChild2MinAge(serviceBO.getChild2MinAge().byteValue());
		}
		if (serviceBO.getChild2Price() != null) {
			serviceDTO.setChild2Price(serviceBO.getChild2Price().doubleValue());
		}
		if (serviceBO.getChild2Qty() != null) {
			serviceDTO.setChild2Qty(serviceBO.getChild2Qty().byteValue());
		}
		if (serviceBO.getChild3MaxAge() != null) {
			serviceDTO.setChild3MaxAge(serviceBO.getChild3MaxAge().byteValue());
		}
		if (serviceBO.getChild3MinAge() != null) {
			serviceDTO.setChild3MinAge(serviceBO.getChild3MinAge().byteValue());
		}
		if (serviceBO.getChild3Price() != null) {
			serviceDTO.setChild3Price(serviceBO.getChild3Price());
		}
		if (serviceBO.getChild3Qty() != null) {
			serviceDTO.setChild3Qty(serviceBO.getChild3Qty().byteValue());
		}
		serviceDTO.setCurrency(serviceBO.getCurrency());
		if (serviceBO.isDateSpecific() != null) {
			serviceDTO.setDateSpecific(serviceBO.isDateSpecific()
					.booleanValue());
		}

		if (serviceBO.getDepatureDate() != null) {
			serviceDTO.setDepatureDate(dateConverterXMLtoUtilDate(serviceBO
					.getDepatureDate()));
		}

		serviceDTO.setDestination(serviceBO.getDestination());
		serviceDTO.setFlightMaterialCode(serviceBO.getFlightMaterialCode());
		if (serviceBO.isFree() != null) {
			serviceDTO.setFree(serviceBO.isFree().booleanValue());
		}
		// setting it to empty string if gateway is null

		if (serviceBO.getGateway() == null) {
			serviceDTO.setGateway("");
		} else {
			serviceDTO.setGateway(serviceBO.getGateway());
		}

		serviceDTO.setGroupCode(serviceBO.getGroupCode());
		serviceDTO.setGroupDescription(serviceBO.getGroupDescription());
		serviceDTO.setGuestAllocation(serviceBO.getGuestAllocation());

		// setting it to empty string if hotelMaterial code is null

		if (serviceBO.getHotelMaterialCode() == null) {
			serviceDTO.setHotelMaterialCode("");
		} else {
			serviceDTO.setHotelMaterialCode(serviceBO.getHotelMaterialCode());
		}
		if (serviceBO.isMandatory() != null) {
			serviceDTO.setMandatory(serviceBO.isMandatory().booleanValue());
		}
		if (serviceBO.getMaxQuantity() != null) {
			serviceDTO.setMaxQuantity(serviceBO.getMaxQuantity().doubleValue());
		}
		if (serviceBO.isMonday() != null) {
			serviceDTO.setMonday(serviceBO.isMonday().booleanValue());
		}
		if (serviceBO.isOccupancyBased() != null) {
			serviceDTO.setOccupancyBased(serviceBO.isOccupancyBased()
					.booleanValue());
		}
		serviceDTO.setOldPosnr(serviceBO.getOldPosnr());
		serviceDTO.setParentItemRph(serviceBO.getParentItemRph());
		serviceDTO.setPosnr(serviceBO.getPosnr());

		// Convert it to Util.date
		if (serviceBO.getReturnDate() != null) {
			serviceDTO.setReturnDate(dateConverterXMLtoUtilDate(serviceBO
					.getReturnDate()));
		}
		if (serviceBO.getSelectedDate() != null) {
			serviceDTO.setSelectedDate(dateConverterXMLtoUtilDate(serviceBO
					.getSelectedDate()));
		}
		if (serviceBO.getAvailableDates() != null) {
			List<Date> availbledatesDTOList = new ArrayList<Date>();
			Date availableDateDTO;
			for (int i = 0; i < serviceBO.getAvailableDates().size(); i++) {
				availableDateDTO = null;
				if (serviceBO.getAvailableDates().get(i) != null) {
					availableDateDTO = dateConverterXMLtoUtilDate(serviceBO
							.getAvailableDates().get(i));
				}
				availbledatesDTOList.add(availableDateDTO);

			}
			serviceDTO.setAvailableDates(availbledatesDTOList);
		}

		if (serviceBO.isSaturday() != null) {
			serviceDTO.setSaturday(serviceBO.isSaturday().booleanValue());
		}
		serviceDTO.setServiceCode(serviceBO.getServiceCode());
		serviceDTO.setServiceName(serviceBO.getServiceName());
		if (serviceBO.isSunday() != null) {
			serviceDTO.setSunday(serviceBO.isSunday().booleanValue());
		}
		serviceDTO.setServiceDescription(serviceBO.getServiceDescription());
		if (serviceBO.isThursday() != null) {
			serviceDTO.setThursday(serviceBO.isThursday().booleanValue());
		}
		if (serviceBO.isTierBased() != null) {
			serviceDTO.setTierBased(serviceBO.isTierBased().booleanValue());
		}

		if (serviceBO.isTuesday() != null) {
			serviceDTO.setTuesday(serviceBO.isTuesday().booleanValue());
		}
		if (serviceBO.getTotalPrice() != null) {
			serviceDTO.setTotalPrice(serviceBO.getTotalPrice().doubleValue());
		}
		if (serviceBO.getTravelAgentFee() != null) {
			serviceDTO.setTravelAgentFee(serviceBO.getTravelAgentFee()
					.doubleValue());
		}
		// Setting Empty String if unit of measure is null

		if (serviceBO.getUnitOfMeasure() == null) {
			serviceDTO.setUnitOfMeasure("");
		} else {
			serviceDTO.setUnitOfMeasure(serviceBO.getUnitOfMeasure());
		}

		if (serviceBO.isWednesday() != null) {
			serviceDTO.setWednesday(serviceBO.isWednesday().booleanValue());
		}
		if (serviceBO.isWeightBased() != null) {
			serviceDTO.setWeightBased(serviceBO.isWeightBased().booleanValue());
		}
	...
	/**
	 * Method to list of ServiceGroups DTO from List<SuppServiceGroup>
	 * 
	 * @param suppServiceGroupsBOList
	 * @return List<ServiceGroup>
	 */
	public List<ServiceGroup> getServiceGroupsDTO(
			List<SuppServiceGroup> suppServiceGroupsBOList) {

		List<ServiceGroup> serviceGroupDTOList = new ArrayList<ServiceGroup>();
		ServiceGroup serviceGroup;
		List<Service> serviceDTOList;
		for (SuppServiceGroup suppserviceGroup : suppServiceGroupsBOList) {
			serviceDTOList = new ArrayList<Service>();
			serviceGroup = new ServiceGroup();
			Service serviceDTO;
			if (suppserviceGroup != null) {
				serviceGroup.setCode(suppserviceGroup.getCode());
				serviceGroup.setDescription(suppserviceGroup.getDescription());
				if (suppserviceGroup.getServices() != null
						&& suppserviceGroup.getServices().size() > 0) {
					for (int i = 0; i < suppserviceGroup.getServices().size(); i++) {
						serviceDTO = new Service();
						// List of services may be null
						if (suppserviceGroup.getServices().get(i) != null) {
							serviceDTO = getServiceDTO(suppserviceGroup
									.getServices().get(i));
						}
				...
				serviceGroup.setServices(serviceDTOList);
			}
			serviceGroupDTOList.add(serviceGroup);

		}

		return serviceGroupDTOList;
	}

	/**
	 * Method to prepare Serviceresponse
	 * 
	 * @param hotelSupplementresponseBO
	 * @return ServicesResponse
	 */
	ServicesResponse getServiceResponeseDTOFromBO(
			HotelsSupplementsResponse hotelSupplementresponseBO) {
		ServicesResponse serviceResponseDTO = new ServicesResponse();
		List<ServiceGroup> serviceGroupList = new ArrayList<ServiceGroup>();
		if (hotelSupplementresponseBO != null) {

			if (hotelSupplementresponseBO.getSuppServiceGroups() != null
					&& hotelSupplementresponseBO.getSuppServiceGroups().size() > 0) {
				serviceResponseDTO
						.setServiceGroups(getServiceGroupsDTO(hotelSupplementresponseBO
								.getSuppServiceGroups()));
			}
		}
	 ...
	 * @return ServicesResponse
	 */
	public ServicesResponse retrieveWESBSupplements(Itinerary itinerary,
			boolean isHbsi,Map<String,HBSiHotelInfo> hbsiHotelList) {
		HotelsSupplementsRequest hotelSuuPlementRequestBO = new HotelsSupplementsRequest();
		ServicesResponse serviceResponseDTO = new ServicesResponse();
		...
		HotelsSupplementsResponse hotelSupplementResponseBO = null;
			...
			for (int i = 0; i < itinerary.getGuests().size(); i++) {
				if (itinerary.getGuests().get(i) != null) {
					itineraryBO.getGuests().add(i,
							getGuestInfoBO(itinerary.getGuests().get(i)));
				}
		...
		if( itinerary.getImApplicationInfo() != null ){
			itineraryBO.setImApplicationInfo( this.getIMApplicationInfoReq(itinerary.getImApplicationInfo()) );
		}
		
		//itineraryBO.setImApplicationInfo(getImApplicationInfo());
		// set the ABEBase attributes

		itineraryBO.setBookingNo(itinerary.getBookingNo());
		hotelSuuPlementRequestBO.setItinerary(itineraryBO);

		/*if (isHbsi == true)
			hotelSuuPlementRequestBO.setIsHBSi(true);*/
		
		if (hbsiHotelList != null
				&& hotelSuuPlementRequestBO != null
				&& hotelSuuPlementRequestBO.getItinerary().getHotels() != null
				&& hotelSuuPlementRequestBO.getItinerary().getHotels()
						.size() > 0)
		{
			for(int j=0;j<hotelSuuPlementRequestBO.getItinerary().getHotels().size();j++)
			{
				if(hbsiHotelList.containsKey(hotelSuuPlementRequestBO.getItinerary().getHotels().get(j).getHotelCode()))
				{
					hotelSuuPlementRequestBO.getItinerary().getHotels().get(j).setIsHBSi(true);
					hotelSuuPlementRequestBO.setIsHBSi(true);
				}
				else
				{
					hotelSuuPlementRequestBO.getItinerary().getHotels().get(j).setIsHBSi(false);
				}
			}
		}
		//set the header elements
		hotelSuuPlementRequestBO.setHotelRequested(true);
		hotelSuuPlementRequestBO.setPackageRequest(false);
		hotelSuuPlementRequestBO.setAirRequested(false);
		hotelSuuPlementRequestBO.setVehicleRequested(false);
		hotelSuuPlementRequestBO.setMultiDestinationRequest(false);
		try {

			hotelSupplementResponseBO = proxyService.getProxyService()
					.retrieveHotelSupplements(hotelSuuPlementRequestBO);

			if (hotelSupplementResponseBO == null) {

				ABEBusinessError businessError = new ABEBusinessError();
				businessError
						.setErrorCode("RETRIEVE_SERVICES_AVAILABILITY_ERROR");
				businessError.setErrorDescription(this.getMessageSource()
						.getMessage("RETRIEVE_SERVICES_AVAILABILITY_ERROR",
								null, null));
				serviceResponseDTO.saveBusinessError(businessError);

			}
			if (hotelSupplementResponseBO != null
					&& hotelSupplementResponseBO.getBusinessError() != null
					&& hotelSupplementResponseBO.getBusinessError().size() > 0) {

				List<ABEBusinessError> businesserrorList = new ArrayList<ABEBusinessError>();

				for (int l = 0; l < hotelSupplementResponseBO
						.getBusinessError().size(); l++) {
					ABEBusinessError businessError = null;
					businessError = this
							.getABEBusinessError(hotelSupplementResponseBO
				...
				if (businesserrorList != null && businesserrorList.size() > 0)
					serviceResponseDTO.saveBusinessErrors(businesserrorList);
			...
			if (hotelSupplementResponseBO != null) {
				serviceResponseDTO = getServiceResponeseDTOFromBO(hotelSupplementResponseBO);
			}
		} catch (RetrieveHotelSupplementsRetrieveHotelSupplementsFaultMsg e) {
	...
	public com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.service.v1.Service getServiceBO(
			Service serviceDTO) {
		...
		if (serviceDTO.getDepatureDate() != null) {
			serviceBO.setDepatureDate(dateConverter(serviceDTO
					.getDepatureDate()));
		}
		...
		if (serviceDTO.getSelectedDate() != null) {
			serviceBO.setSelectedDate(dateConverter(serviceDTO
					.getSelectedDate()));
		}
		...
		if (serviceDTO.getServiceDescription() != null) {
			for (int i = 0; i < serviceDTO.getServiceDescription().size(); i++) {
				serviceBO.getServiceDescription().add(i,
						serviceDTO.getServiceDescription().get(i));
			}
		}
		if (serviceDTO.getAvailableDates() != null) {
			for (int i = 0; i < serviceDTO.getAvailableDates().size(); i++) {
				if (serviceDTO.getAvailableDates().get(i) != null) {
					serviceBO.getAvailableDates()
							.add(i,
									dateConverter(serviceDTO
											.getAvailableDates().get(i)));
				}
			}
		}
	...
	/**
	 * Method to prepare ServiceDetailsResponse
	 * 
	 * @param hotelSupplementsDetailsResponseBO
	 * @return ServiceDetailsResponse
	 * 
	 */
	public ServiceDetailsResponse getServiceDetailsResonseDTO(
			HotelsSupplementsDetailsResponse hotelSupplementsDetailsResponseBO) {
		ServiceDetailsResponse serviceDetailsResponseDTO = new ServiceDetailsResponse();
		Service serviceDTO = new Service();
		com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.service.v1.Service serviceBO = new com.kcdataservices.partners.kcdebdmnlib_hva.businessobjects.service.v1.Service();
		if (hotelSupplementsDetailsResponseBO != null) {
			serviceBO = hotelSupplementsDetailsResponseBO.getService();
		}

		if (serviceBO != null) {
			serviceDTO = getServiceDTO(serviceBO);
		}
		serviceDetailsResponseDTO.setService(serviceDTO);

		return serviceDetailsResponseDTO;
	}
