...
public class Y_Bapi_Search_Bookings_Output extends com.sap.aii.proxy.framework.core.AbstractType{
    ...
    protected  Y_Bapi_Search_Bookings_Output (com.sap.aii.proxy.framework.core.BaseTypeDescriptor descriptor, com.sap.aii.proxy.framework.core.GenerationInfo staticGenerationInfo, int connectionType) {
        super(descriptor, staticGenerationInfo, connectionType);
    }

    public  Y_Bapi_Search_Bookings_Output () {
    ...
    public MetaData metadataY_Bapi_Search_Bookings_Output() {
        return metadata;
    }
    ...
    public static class MetaData implements java.io.Serializable {
        ...
        private  Y_Bapi_Search_Bookings_Output parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (Y_Bapi_Search_Bookings_Output parent) {
            this.parent = parent;
