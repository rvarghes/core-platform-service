...
public class Zsbook_LocType extends com.sap.aii.proxy.framework.core.AbstractType{
    ...
    private  Zsbook_LocType.MetaData metadata = new MetaData(this) ;

    static {
        com.sap.aii.proxy.framework.core.BaseTypeDescriptor descriptor = createNewBaseTypeDescriptor(com.sap.aii.proxy.framework.core.XsdlConstants.XSDL_COMPLEX_TYPE, "urn:sap-com:document:sap:rfc:functions", "ZSBOOK_LOC", 8, 0, com.kcdata.abe.bapi.Zsbook_LocType.class, com.sap.aii.proxy.framework.core.FactoryConstants.CONNECTION_TYPE_JCO, "ZSBOOK_LOC", 92, 184, -1, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<s0:type name=\"ZSBOOK_LOC\" xmlns:s0=\"urn:sap-com:document:sap:rfc:functions\"><ifr:container xmlns:ifr=\"urn:sap-com:ifr:v2:metamodel\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"><ifr:descriptor><ifr:description language=\"EN\">Sales order - Locked documents log</ifr:description></ifr:descriptor><ifr:properties><ifr:sourceSystem /><ifr:sourceClient>300</ifr:sourceClient><ifr:release>700 </ifr:release><ifr:category>structure</ifr:category><ifr:unicode1>true</ifr:unicode1><ifr:unicode2>true</ifr:unicode2><ifr:isFlatStructure>false</ifr:isFlatStructure></ifr:properties><ifr:definition><ifr:internalLength1>92</ifr:internalLength1><ifr:internalLength2>184</ifr:internalLength2></ifr:definition></ifr:container></s0:type>");
    ...
    public  Zsbook_LocType () {
        super(staticDescriptor, staticGenerationInfo, com.sap.aii.proxy.framework.core.FactoryConstants.CONNECTION_TYPE_JCO);
        
    }

    protected  Zsbook_LocType (com.sap.aii.proxy.framework.core.BaseTypeDescriptor descriptor, com.sap.aii.proxy.framework.core.GenerationInfo staticGenerationInfo, int connectionType) {
    ...
    public static class MetaData implements java.io.Serializable {
        ...
        private  Zsbook_LocType parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (Zsbook_LocType parent) {
            this.parent = parent;
