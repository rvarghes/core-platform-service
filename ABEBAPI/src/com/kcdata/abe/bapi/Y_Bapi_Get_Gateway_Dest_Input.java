...
public class Y_Bapi_Get_Gateway_Dest_Input extends com.sap.aii.proxy.framework.core.AbstractType{
    ...
    public com.kcdata.abe.bapi.Yst_LocinfoType[] getIt_Destinations() {
        com.kcdata.abe.bapi.util.Yst_LocinfoType_List i$ = (com.kcdata.abe.bapi.util.Yst_LocinfoType_List)baseTypeData().getElementValue(5);
    ...
    public com.kcdata.abe.bapi.util.Ynearby_AirportType_List get_as_listIt_Nearby_Airport() {
        return (com.kcdata.abe.bapi.util.Ynearby_AirportType_List)baseTypeData().getElementValue(3);
    }

    public com.kcdata.abe.bapi.util.Yst_LocinfoType_List get_as_listIt_Destinations() {
        return (com.kcdata.abe.bapi.util.Yst_LocinfoType_List)baseTypeData().getElementValue(5);
    }
    ...
    public void setIt_Nearby_Airport(com.kcdata.abe.bapi.Ynearby_AirportType[] It_Nearby_Airport) {
        baseTypeData().setElementValue(3, new com.kcdata.abe.bapi.util.Ynearby_AirportType_List());
    ...
    public com.kcdata.abe.bapi.Ynearby_AirportType[] getIt_Nearby_Airport() {
        com.kcdata.abe.bapi.util.Ynearby_AirportType_List i$ = (com.kcdata.abe.bapi.util.Ynearby_AirportType_List)baseTypeData().getElementValue(3);
        if ( i$ == null){return null;}
    ...
    public void setIt_Destinations(com.kcdata.abe.bapi.Yst_LocinfoType[] It_Destinations) {
        baseTypeData().setElementValue(5, new com.kcdata.abe.bapi.util.Yst_LocinfoType_List());
    ...
    public void setIt_Destinations(com.kcdata.abe.bapi.util.Yst_LocinfoType_List It_Destinations) {
        baseTypeData().setElementValue(5, It_Destinations);
    }
    ...
    public static class MetaData implements java.io.Serializable {
        ...
        private  Y_Bapi_Get_Gateway_Dest_Input parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (Y_Bapi_Get_Gateway_Dest_Input parent) {
            this.parent = parent;
