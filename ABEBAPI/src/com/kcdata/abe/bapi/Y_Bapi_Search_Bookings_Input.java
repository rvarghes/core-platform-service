...
public class Y_Bapi_Search_Bookings_Input extends com.sap.aii.proxy.framework.core.AbstractType{

    private  static final com.sap.aii.proxy.framework.core.BaseTypeDescriptor staticDescriptor ;

    private  static final com.sap.aii.proxy.framework.core.GenerationInfo staticGenerationInfo = new com.sap.aii.proxy.framework.core.GenerationInfo("2.0", 1252419490015L) ;

    private  Y_Bapi_Search_Bookings_Input.MetaData metadata = new MetaData(this) ;

    static {
        com.sap.aii.proxy.framework.core.BaseTypeDescriptor descriptor = createNewBaseTypeDescriptor(com.sap.aii.proxy.framework.core.XsdlConstants.WSDL_MESSAGE_FOR_JCO, "urn:sap-com:document:sap:rfc:functions", "Y_BAPI_SEARCH_BOOKINGS.Input", 4, 0, com.kcdata.abe.bapi.Y_Bapi_Search_Bookings_Input.class, com.sap.aii.proxy.framework.core.FactoryConstants.CONNECTION_TYPE_JCO, "Y_BAPI_SEARCH_BOOKINGS", 0, 0, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:container xmlns:ifr=\"urn:sap-com:ifr:v2:metamodel\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"><ifr:descriptor><ifr:description language=\"EN\">BAPI for Booking Search</ifr:description></ifr:descriptor><ifr:properties><ifr:sourceSystem /><ifr:sourceClient>130</ifr:sourceClient><ifr:release>700 </ifr:release><ifr:package>YABE</ifr:package><ifr:akhNode>HLB0009075</ifr:akhNode><ifr:released>no</ifr:released><ifr:outbound>false</ifr:outbound><ifr:synchronous>true</ifr:synchronous><ifr:asynchronous>false</ifr:asynchronous><ifr:unicode1>true</ifr:unicode1><ifr:unicode2>true</ifr:unicode2></ifr:properties><ifr:definition /></ifr:container>");
        ...
        descriptorSetElementProperties(descriptor, 1, "IM_SEARCH_PARA", null, null, "unqualified", "urn:sap-com:document:sap:rfc:functions:YST_BOOK_PARA", "urn:sap-com:document:sap:rfc:functions", false, 1, 1, false, null, "Im_Search_Para", com.kcdata.abe.bapi.Yst_Book_ParaType.class, new com.kcdata.abe.bapi.Yst_Book_ParaType(), new java.lang.String[][]{}, "IM_SEARCH_PARA", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_STRUCTURE, com.sap.mw.jco.JCO.IMPORT_PARAMETER, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"IM_SEARCH_PARA\"><ifr:descriptor><ifr:description language=\"EN\">Booking search-communication structure input</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"YST_BOOK_PARA\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=YST_BOOK_PARA\" /></ifr:definition><ifr:properties><ifr:direction>in</ifr:direction><ifr:class>import</ifr:class><ifr:type>structure</ifr:type><ifr:optional>false</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 2, "IT_SEARCHRESULTS", null, null, "unqualified", null, "urn:sap-com:document:sap:rfc:functions", false, 0, -1, false, null, "It_Searchresults", com.kcdata.abe.bapi.util.Yst_Book_ResType_List.class, new com.kcdata.abe.bapi.Yst_Book_ResType(), new java.lang.String[][]{}, "IT_SEARCHRESULTS", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_TABLE, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"IT_SEARCHRESULTS\"><ifr:descriptor><ifr:description language=\"EN\">Orders Search Results</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"YST_BOOK_RES\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=YST_BOOK_RES\" /></ifr:definition><ifr:properties><ifr:direction>inout</ifr:direction><ifr:class>tables</ifr:class><ifr:type>structure</ifr:type><ifr:optional>false</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
    ...
    protected  Y_Bapi_Search_Bookings_Input (com.sap.aii.proxy.framework.core.BaseTypeDescriptor descriptor, com.sap.aii.proxy.framework.core.GenerationInfo staticGenerationInfo, int connectionType) {
        super(descriptor, staticGenerationInfo, connectionType);
    }

    public  Y_Bapi_Search_Bookings_Input () {
    ...
    public void setIm_Search_Para(com.kcdata.abe.bapi.Yst_Book_ParaType Im_Search_Para) {
        baseTypeData().setElementValue(1, Im_Search_Para);
    }

    public void setIt_Searchresults(com.kcdata.abe.bapi.util.Yst_Book_ResType_List It_Searchresults) {
        baseTypeData().setElementValue(2, It_Searchresults);
    }
    ...
    public com.kcdata.abe.bapi.util.Yst_Book_ResType_List get_as_listIt_Searchresults() {
        return (com.kcdata.abe.bapi.util.Yst_Book_ResType_List)baseTypeData().getElementValue(2);
    }

    public MetaData metadataY_Bapi_Search_Bookings_Input() {
        return metadata;
    }
    ...
    public com.kcdata.abe.bapi.Yst_Book_ResType[] getIt_Searchresults() {
        com.kcdata.abe.bapi.util.Yst_Book_ResType_List i$ = (com.kcdata.abe.bapi.util.Yst_Book_ResType_List)baseTypeData().getElementValue(2);
        if ( i$ == null){return null;}
        return  i$.toArrayYst_Book_ResType();
    }

    public void setIt_Searchresults(com.kcdata.abe.bapi.Yst_Book_ResType[] It_Searchresults) {
        baseTypeData().setElementValue(2, new com.kcdata.abe.bapi.util.Yst_Book_ResType_List());
    ...
    public com.kcdata.abe.bapi.Yst_Book_ParaType getIm_Search_Para() {
        return (com.kcdata.abe.bapi.Yst_Book_ParaType)baseTypeData().getElementValue(1);
    }
    ...
    public static class MetaData implements java.io.Serializable {
        ...
        private  Y_Bapi_Search_Bookings_Input parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (Y_Bapi_Search_Bookings_Input parent) {
            this.parent = parent;
        ...
        public com.sap.aii.proxy.framework.core.JcoMetaData getIm_Search_Para() {
