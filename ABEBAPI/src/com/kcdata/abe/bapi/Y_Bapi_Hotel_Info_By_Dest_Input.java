...
public class Y_Bapi_Hotel_Info_By_Dest_Input extends com.sap.aii.proxy.framework.core.AbstractType{
    ...
    static {
        ...
        descriptorSetElementProperties(descriptor, 1, "IM_DEST", null, null, "unqualified", "http://www.w3.org/2001/XMLSchema:string", "urn:sap-com:document:sap:rfc:functions", false, 1, 1, false, null, "Im_Dest", java.lang.String.class, null, new java.lang.String[][]{{"maxLength", "5"}}, "IM_DEST", 0, 0, -1, 5, 10, -1, com.sap.mw.jco.JCO.TYPE_CHAR, com.sap.mw.jco.JCO.IMPORT_PARAMETER, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"IM_DEST\"><ifr:descriptor><ifr:description language=\"EN\">Destination.</ifr:description></ifr:descriptor><ifr:definition><ifr:scalarType name=\"ZZDEST\"><ifr:properties><ifr:helpValuesSupported>false</ifr:helpValuesSupported><ifr:fixedValuesListDefined>false</ifr:fixedValuesListDefined><ifr:mixedCaseSupported>false</ifr:mixedCaseSupported><ifr:signedNumber>false</ifr:signedNumber></ifr:properties><ifr:definition><ifr:type>CHAR</ifr:type><ifr:abapType>C</ifr:abapType><ifr:length>5</ifr:length><ifr:internalLength1>5</ifr:internalLength1><ifr:internalLength2>10</ifr:internalLength2><ifr:decimals>0</ifr:decimals><ifr:outputLength>5</ifr:outputLength></ifr:definition></ifr:scalarType></ifr:definition><ifr:properties><ifr:direction>in</ifr:direction><ifr:class>import</ifr:class><ifr:type>scalar</ifr:type><ifr:optional>false</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
    ...
    public void setIt_Htl_Info(com.kcdata.abe.bapi.Yst_Htl_DataType[] It_Htl_Info) {
        baseTypeData().setElementValue(3, new com.kcdata.abe.bapi.util.Yst_Htl_DataType_List());
    ...
    public void setIm_Dest(java.lang.String Im_Dest) {
        baseTypeData().setElementValue(1, Im_Dest);
    }

    public MetaData metadataY_Bapi_Hotel_Info_By_Dest_Input() {
        return metadata;
    }

    public com.kcdata.abe.bapi.util.Yst_Htl_DataType_List get_as_listIt_Htl_Info() {
        return (com.kcdata.abe.bapi.util.Yst_Htl_DataType_List)baseTypeData().getElementValue(3);
    }

    public java.lang.String getIm_Dest() {
        return (java.lang.String)baseTypeData().getElementValueAsString(1);
    }

    public void setIt_Htl_Info(com.kcdata.abe.bapi.util.Yst_Htl_DataType_List It_Htl_Info) {
        baseTypeData().setElementValue(3, It_Htl_Info);
    }

    public void setIt_Hl_Chain(com.kcdata.abe.bapi.util.Yst_Htl_ChainType_List It_Hl_Chain) {
        baseTypeData().setElementValue(4, It_Hl_Chain);
    }
    ...
    public com.kcdata.abe.bapi.Yst_Htl_ChainType[] getIt_Hl_Chain() {
        com.kcdata.abe.bapi.util.Yst_Htl_ChainType_List i$ = (com.kcdata.abe.bapi.util.Yst_Htl_ChainType_List)baseTypeData().getElementValue(4);
        if ( i$ == null){return null;}
        return  i$.toArrayYst_Htl_ChainType();
    }

    public void setIt_Hl_Chain(com.kcdata.abe.bapi.Yst_Htl_ChainType[] It_Hl_Chain) {
        baseTypeData().setElementValue(4, new com.kcdata.abe.bapi.util.Yst_Htl_ChainType_List());
    ...
    public com.kcdata.abe.bapi.Yst_Htl_DataType[] getIt_Htl_Info() {
        com.kcdata.abe.bapi.util.Yst_Htl_DataType_List i$ = (com.kcdata.abe.bapi.util.Yst_Htl_DataType_List)baseTypeData().getElementValue(3);
        if ( i$ == null){return null;}
        return  i$.toArrayYst_Htl_DataType();
    }

    public com.kcdata.abe.bapi.util.Yst_Htl_ChainType_List get_as_listIt_Hl_Chain() {
        return (com.kcdata.abe.bapi.util.Yst_Htl_ChainType_List)baseTypeData().getElementValue(4);
    }
    ...
    public static class MetaData implements java.io.Serializable {
        ...
        private  Y_Bapi_Hotel_Info_By_Dest_Input parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (Y_Bapi_Hotel_Info_By_Dest_Input parent) {
            this.parent = parent;
        ...
        public com.sap.aii.proxy.framework.core.JcoMetaData getIm_Dest() {
