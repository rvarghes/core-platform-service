...
public class Y_Ota_Flight_Availability_Output extends com.sap.aii.proxy.framework.core.AbstractType{
    ...
    public MetaData metadataY_Ota_Flight_Availability_Output() {
        return metadata;
    }

    public com.kcdata.abe.bapi.Yst_Ota_Flt_Orig_DestType[] getIt_Ota_Flt_Orig_Dest() {
        com.kcdata.abe.bapi.util.Yst_Ota_Flt_Orig_DestType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_Flt_Orig_DestType_List)baseTypeData().getElementValue(5);
        if ( i$ == null){return null;}
    ...
    public com.kcdata.abe.bapi.Yst_Ota_Flt_ReqType[] getIt_Ota_Flt_Req() {
        com.kcdata.abe.bapi.util.Yst_Ota_Flt_ReqType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_Flt_ReqType_List)baseTypeData().getElementValue(3);
        if ( i$ == null){return null;}
    ...
    public com.kcdata.abe.bapi.util.Yst_Ota_Flt_PrefsType_List get_as_listIt_Ota_Flt_Prefs() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_Flt_PrefsType_List)baseTypeData().getElementValue(4);
    }

    public void setIt_Ota_Flt_Req(com.kcdata.abe.bapi.Yst_Ota_Flt_ReqType[] It_Ota_Flt_Req) {
        baseTypeData().setElementValue(3, new com.kcdata.abe.bapi.util.Yst_Ota_Flt_ReqType_List());
    ...
    public void setIt_Ota_Flt_Orig_Dest(com.kcdata.abe.bapi.Yst_Ota_Flt_Orig_DestType[] It_Ota_Flt_Orig_Dest) {
        baseTypeData().setElementValue(5, new com.kcdata.abe.bapi.util.Yst_Ota_Flt_Orig_DestType_List());
    ...
    public void setIt_Ota_Flt_Prefs(com.kcdata.abe.bapi.Yst_Ota_Flt_PrefsType[] It_Ota_Flt_Prefs) {
        baseTypeData().setElementValue(4, new com.kcdata.abe.bapi.util.Yst_Ota_Flt_PrefsType_List());
    ...
    public void setIt_Ota_Flt_Orig_Dest(com.kcdata.abe.bapi.util.Yst_Ota_Flt_Orig_DestType_List It_Ota_Flt_Orig_Dest) {
        baseTypeData().setElementValue(5, It_Ota_Flt_Orig_Dest);
    }

    public void setIt_Ota_Flt_Prefs(com.kcdata.abe.bapi.util.Yst_Ota_Flt_PrefsType_List It_Ota_Flt_Prefs) {
        baseTypeData().setElementValue(4, It_Ota_Flt_Prefs);
    }

    public void setIt_Ota_Flt_Req(com.kcdata.abe.bapi.util.Yst_Ota_Flt_ReqType_List It_Ota_Flt_Req) {
        baseTypeData().setElementValue(3, It_Ota_Flt_Req);
    }

    public com.kcdata.abe.bapi.Yst_Ota_Flt_PrefsType[] getIt_Ota_Flt_Prefs() {
        com.kcdata.abe.bapi.util.Yst_Ota_Flt_PrefsType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_Flt_PrefsType_List)baseTypeData().getElementValue(4);
        if ( i$ == null){return null;}
    ...
    public static class MetaData implements java.io.Serializable {
        ...
        private  Y_Ota_Flight_Availability_Output parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (Y_Ota_Flight_Availability_Output parent) {
            this.parent = parent;
