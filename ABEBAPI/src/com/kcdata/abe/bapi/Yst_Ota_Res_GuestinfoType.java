...
public class Yst_Ota_Res_GuestinfoType extends com.sap.aii.proxy.framework.core.AbstractType{
    ...
    static {
        ...
        descriptorSetElementProperties(descriptor, 37, "PNRNUMBER", null, null, "unqualified", "http://www.w3.org/2001/XMLSchema:string", "urn:sap-com:document:sap:rfc:functions", false, 0, 1, false, null, "Pnrnumber", java.lang.String.class, null, new java.lang.String[][]{{"maxLength", "60"}}, "PNRNUMBER", 828, 1656, -1, 60, 120, -1, com.sap.mw.jco.JCO.TYPE_CHAR, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:field name=\"PNRNUMBER\" category=\"simple\"><ifr:descriptor><ifr:description language=\"EN\">PNR Numbers</ifr:description></ifr:descriptor><ifr:properties><ifr:helpValuesSupported>false</ifr:helpValuesSupported><ifr:offset1>828</ifr:offset1><ifr:offset2>1656</ifr:offset2></ifr:properties><ifr:definition><ifr:scalarType name=\"YPNRNO\"><ifr:properties><ifr:helpValuesSupported>false</ifr:helpValuesSupported><ifr:fixedValuesListDefined>false</ifr:fixedValuesListDefined><ifr:mixedCaseSupported>false</ifr:mixedCaseSupported><ifr:signedNumber>false</ifr:signedNumber></ifr:properties><ifr:definition><ifr:type>CHAR</ifr:type><ifr:abapType>C</ifr:abapType><ifr:length>60</ifr:length><ifr:internalLength1>60</ifr:internalLength1><ifr:internalLength2>120</ifr:internalLength2><ifr:decimals>0</ifr:decimals><ifr:outputLength>60</ifr:outputLength></ifr:definition></ifr:scalarType></ifr:definition></ifr:field>");
        descriptorSetElementProperties(descriptor, 38, "PAX_BKST", null, null, "unqualified", "http://www.w3.org/2001/XMLSchema:string", "urn:sap-com:document:sap:rfc:functions", false, 0, 1, false, null, "Pax_Bkst", java.lang.String.class, null, new java.lang.String[][]{{"maxLength", "10"}}, "PAX_BKST", 888, 1776, -1, 10, 20, -1, com.sap.mw.jco.JCO.TYPE_CHAR, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:field name=\"PAX_BKST\" category=\"simple\"><ifr:descriptor><ifr:description language=\"EN\">Pax Booking Status</ifr:description></ifr:descriptor><ifr:properties><ifr:helpValuesSupported>false</ifr:helpValuesSupported><ifr:offset1>888</ifr:offset1><ifr:offset2>1776</ifr:offset2></ifr:properties><ifr:definition><ifr:scalarType name=\"ZZPBKST\"><ifr:properties><ifr:helpValuesSupported>false</ifr:helpValuesSupported><ifr:fixedValuesListDefined>false</ifr:fixedValuesListDefined><ifr:mixedCaseSupported>false</ifr:mixedCaseSupported><ifr:signedNumber>false</ifr:signedNumber></ifr:properties><ifr:definition><ifr:type>CHAR</ifr:type><ifr:abapType>C</ifr:abapType><ifr:length>10</ifr:length><ifr:internalLength1>10</ifr:internalLength1><ifr:internalLength2>20</ifr:internalLength2><ifr:decimals>0</ifr:decimals><ifr:outputLength>10</ifr:outputLength></ifr:definition></ifr:scalarType></ifr:definition></ifr:field>");
        descriptorSetElementProperties(descriptor, 39, "NAME_MDL", null, null, "unqualified", "http://www.w3.org/2001/XMLSchema:string", "urn:sap-com:document:sap:rfc:functions", false, 0, 1, false, null, "Name_Mdl", java.lang.String.class, null, new java.lang.String[][]{{"maxLength", "30"}}, "NAME_MDL", 898, 1796, -1, 30, 60, -1, com.sap.mw.jco.JCO.TYPE_CHAR, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:field name=\"NAME_MDL\" category=\"simple\"><ifr:descriptor><ifr:description language=\"EN\">Middle Name</ifr:description></ifr:descriptor><ifr:properties><ifr:helpValuesSupported>false</ifr:helpValuesSupported><ifr:offset1>898</ifr:offset1><ifr:offset2>1796</ifr:offset2></ifr:properties><ifr:definition><ifr:scalarType name=\"ZNAME_MDL\"><ifr:properties><ifr:helpValuesSupported>false</ifr:helpValuesSupported><ifr:fixedValuesListDefined>false</ifr:fixedValuesListDefined><ifr:mixedCaseSupported>false</ifr:mixedCaseSupported><ifr:signedNumber>false</ifr:signedNumber></ifr:properties><ifr:definition><ifr:type>CHAR</ifr:type><ifr:abapType>C</ifr:abapType><ifr:length>30</ifr:length><ifr:internalLength1>30</ifr:internalLength1><ifr:internalLength2>60</ifr:internalLength2><ifr:decimals>0</ifr:decimals><ifr:outputLength>30</ifr:outputLength></ifr:definition></ifr:scalarType></ifr:definition></ifr:field>");
        descriptorSetElementProperties(descriptor, 40, "DHSREADRESS", null, null, "unqualified", "http://www.w3.org/2001/XMLSchema:string", "urn:sap-com:document:sap:rfc:functions", false, 0, 1, false, null, "Dhsreadress", java.lang.String.class, null, new java.lang.String[][]{{"maxLength", "13"}}, "DHSREADRESS", 928, 1856, -1, 13, 26, -1, com.sap.mw.jco.JCO.TYPE_CHAR, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:field name=\"DHSREADRESS\" category=\"simple\"><ifr:descriptor><ifr:description language=\"EN\">Passenger DHS Redress Number</ifr:description></ifr:descriptor><ifr:properties><ifr:helpValuesSupported>false</ifr:helpValuesSupported><ifr:offset1>928</ifr:offset1><ifr:offset2>1856</ifr:offset2></ifr:properties><ifr:definition><ifr:scalarType name=\"ZDHSREADRESS\"><ifr:properties><ifr:helpValuesSupported>false</ifr:helpValuesSupported><ifr:fixedValuesListDefined>false</ifr:fixedValuesListDefined><ifr:mixedCaseSupported>false</ifr:mixedCaseSupported><ifr:signedNumber>false</ifr:signedNumber></ifr:properties><ifr:definition><ifr:type>CHAR</ifr:type><ifr:abapType>C</ifr:abapType><ifr:length>13</ifr:length><ifr:internalLength1>13</ifr:internalLength1><ifr:internalLength2>26</ifr:internalLength2><ifr:decimals>0</ifr:decimals><ifr:outputLength>13</ifr:outputLength></ifr:definition></ifr:scalarType></ifr:definition></ifr:field>");
        descriptorSetElementProperties(descriptor, 41, "PAX_WEIGHT", null, null, "unqualified", "http://www.w3.org/2001/XMLSchema:string", "urn:sap-com:document:sap:rfc:functions", false, 0, 1, false, null, "Pax_Weight", java.lang.String.class, null, new java.lang.String[][]{{"maxLength", "3"}}, "PAX_WEIGHT", 941, 1882, -1, 3, 6, -1, com.sap.mw.jco.JCO.TYPE_CHAR, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:field name=\"PAX_WEIGHT\" category=\"simple\"><ifr:descriptor><ifr:description language=\"EN\">PAX Weight</ifr:description></ifr:descriptor><ifr:properties><ifr:helpValuesSupported>false</ifr:helpValuesSupported><ifr:offset1>941</ifr:offset1><ifr:offset2>1882</ifr:offset2></ifr:properties><ifr:definition><ifr:scalarType name=\"Z_PAXWT\"><ifr:properties><ifr:helpValuesSupported>false</ifr:helpValuesSupported><ifr:fixedValuesListDefined>false</ifr:fixedValuesListDefined><ifr:mixedCaseSupported>false</ifr:mixedCaseSupported><ifr:signedNumber>false</ifr:signedNumber></ifr:properties><ifr:definition><ifr:type>CHAR</ifr:type><ifr:abapType>C</ifr:abapType><ifr:length>3</ifr:length><ifr:internalLength1>3</ifr:internalLength1><ifr:internalLength2>6</ifr:internalLength2><ifr:decimals>0</ifr:decimals><ifr:outputLength>3</ifr:outputLength></ifr:definition></ifr:scalarType></ifr:definition></ifr:field>");
        staticDescriptor = descriptor;
    }
    public  Yst_Ota_Res_GuestinfoType () {
        super(staticDescriptor, staticGenerationInfo, com.sap.aii.proxy.framework.core.FactoryConstants.CONNECTION_TYPE_JCO);
        
    }

    protected  Yst_Ota_Res_GuestinfoType (com.sap.aii.proxy.framework.core.BaseTypeDescriptor descriptor, com.sap.aii.proxy.framework.core.GenerationInfo staticGenerationInfo, int connectionType) {
    ...
    public void setName_Mdl(java.lang.String Name_Mdl) {
        baseTypeData().setElementValue(39, Name_Mdl);
    }
    ...
    public java.lang.String getPax_Bkst() {
    ...
    public void setPnrnumber(java.lang.String Pnrnumber) {
        baseTypeData().setElementValue(37, Pnrnumber);
    }
    ...
    public void setDhsreadress(java.lang.String Dhsreadress) {
        baseTypeData().setElementValue(40, Dhsreadress);
    }
    ...
    public void setPax_Bkst(java.lang.String Pax_Bkst) {
        baseTypeData().setElementValue(38, Pax_Bkst);
    }
    ...
    public static class MetaData implements java.io.Serializable {
        ...
        private  Yst_Ota_Res_GuestinfoType parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (Yst_Ota_Res_GuestinfoType parent) {
            this.parent = parent;
        ...
        public com.sap.aii.proxy.framework.core.JcoMetaData getPax_Bkst() {
