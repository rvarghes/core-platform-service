...
public class Y_Bapi_Insurance_Availability_Input extends com.sap.aii.proxy.framework.core.AbstractType{
    ...
    static {
        ...
        descriptorSetElementProperties(descriptor, 2, "IM_BAPI_INS_REQ", null, null, "unqualified", "urn:sap-com:document:sap:rfc:functions:YST_BAPI_INS_REQ", "urn:sap-com:document:sap:rfc:functions", false, 1, 1, false, null, "Im_Bapi_Ins_Req", com.kcdata.abe.bapi.Yst_Bapi_Ins_ReqType.class, new com.kcdata.abe.bapi.Yst_Bapi_Ins_ReqType(), new java.lang.String[][]{}, "IM_BAPI_INS_REQ", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_STRUCTURE, com.sap.mw.jco.JCO.IMPORT_PARAMETER, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"IM_BAPI_INS_REQ\"><ifr:descriptor><ifr:description language=\"EN\">AVOK Insurance BAPI Request</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"YST_BAPI_INS_REQ\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=YST_BAPI_INS_REQ\" /></ifr:definition><ifr:properties><ifr:direction>in</ifr:direction><ifr:class>import</ifr:class><ifr:type>structure</ifr:type><ifr:optional>false</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
    ...
    public void setIt_Ins_Avail(com.kcdata.abe.bapi.util.Yst_Bapi_Ins_AvailabilityType_List It_Ins_Avail) {
        baseTypeData().setElementValue(5, It_Ins_Avail);
    }

    public void setIt_Guestinfo(com.kcdata.abe.bapi.Yst_Ota_GuestinfoType[] It_Guestinfo) {
        baseTypeData().setElementValue(7, new com.kcdata.abe.bapi.util.Yst_Ota_GuestinfoType_List());
    ...
    public void setIt_Flt_Segments(com.kcdata.abe.bapi.Yst_Ota_Flt_SegmentsType[] It_Flt_Segments) {
        baseTypeData().setElementValue(8, new com.kcdata.abe.bapi.util.Yst_Ota_Flt_SegmentsType_List());
    ...
    public com.kcdata.abe.bapi.util.Yst_Ota_GuestinfoType_List get_as_listIt_Guestinfo() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_GuestinfoType_List)baseTypeData().getElementValue(7);
    }

    public com.kcdata.abe.bapi.Yst_Bapi_Long_TextType[] getIt_Mat_Long_Text() {
        com.kcdata.abe.bapi.util.Yst_Bapi_Long_TextType_List i$ = (com.kcdata.abe.bapi.util.Yst_Bapi_Long_TextType_List)baseTypeData().getElementValue(4);
        if ( i$ == null){return null;}
    ...
    public com.kcdata.abe.bapi.Yst_Ota_Flt_SegmentsType[] getIt_Flt_Segments() {
        com.kcdata.abe.bapi.util.Yst_Ota_Flt_SegmentsType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_Flt_SegmentsType_List)baseTypeData().getElementValue(8);
        if ( i$ == null){return null;}
        return  i$.toArrayYst_Ota_Flt_SegmentsType();
    }

    public void setIm_Bapi_Ins_Req(com.kcdata.abe.bapi.Yst_Bapi_Ins_ReqType Im_Bapi_Ins_Req) {
        baseTypeData().setElementValue(2, Im_Bapi_Ins_Req);
    }

    public com.kcdata.abe.bapi.util.Yst_Bapi_Ins_AvailabilityType_List get_as_listIt_Ins_Avail() {
        return (com.kcdata.abe.bapi.util.Yst_Bapi_Ins_AvailabilityType_List)baseTypeData().getElementValue(5);
    }

    public com.kcdata.abe.bapi.Yst_Bapi_Ins_ReqType getIm_Bapi_Ins_Req() {
        return (com.kcdata.abe.bapi.Yst_Bapi_Ins_ReqType)baseTypeData().getElementValue(2);
    }

    public void setIt_Ins_Avail(com.kcdata.abe.bapi.Yst_Bapi_Ins_AvailabilityType[] It_Ins_Avail) {
        baseTypeData().setElementValue(5, new com.kcdata.abe.bapi.util.Yst_Bapi_Ins_AvailabilityType_List());
    ...
    public void setIt_Mat_Long_Text(com.kcdata.abe.bapi.util.Yst_Bapi_Long_TextType_List It_Mat_Long_Text) {
        baseTypeData().setElementValue(4, It_Mat_Long_Text);
    }

    public com.kcdata.abe.bapi.Yst_Ota_GuestinfoType[] getIt_Guestinfo() {
        com.kcdata.abe.bapi.util.Yst_Ota_GuestinfoType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_GuestinfoType_List)baseTypeData().getElementValue(7);
        if ( i$ == null){return null;}
    ...
    public void setIt_Mat_Long_Text(com.kcdata.abe.bapi.Yst_Bapi_Long_TextType[] It_Mat_Long_Text) {
        baseTypeData().setElementValue(4, new com.kcdata.abe.bapi.util.Yst_Bapi_Long_TextType_List());
    ...
    public com.kcdata.abe.bapi.util.Yst_Ota_Flt_SegmentsType_List get_as_listIt_Flt_Segments() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_Flt_SegmentsType_List)baseTypeData().getElementValue(8);
    }
    ...
    public com.kcdata.abe.bapi.Yst_Bapi_Ins_AvailabilityType[] getIt_Ins_Avail() {
        com.kcdata.abe.bapi.util.Yst_Bapi_Ins_AvailabilityType_List i$ = (com.kcdata.abe.bapi.util.Yst_Bapi_Ins_AvailabilityType_List)baseTypeData().getElementValue(5);
        if ( i$ == null){return null;}
        return  i$.toArrayYst_Bapi_Ins_AvailabilityType();
    }

    public MetaData metadataY_Bapi_Insurance_Availability_Input() {
        return metadata;
    }
    ...
    public void setIt_Guestinfo(com.kcdata.abe.bapi.util.Yst_Ota_GuestinfoType_List It_Guestinfo) {
        baseTypeData().setElementValue(7, It_Guestinfo);
    }

    public static class MetaData implements java.io.Serializable {
    
        private  Y_Bapi_Insurance_Availability_Input parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (Y_Bapi_Insurance_Availability_Input parent) {
            this.parent = parent;
        ...
        public com.sap.aii.proxy.framework.core.JcoMetaData getIm_Bapi_Ins_Req() {
