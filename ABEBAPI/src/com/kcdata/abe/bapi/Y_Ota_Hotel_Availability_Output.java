...
public class Y_Ota_Hotel_Availability_Output extends com.sap.aii.proxy.framework.core.AbstractType{
    ...
    public com.kcdata.abe.bapi.Yst_Ota_Htl_AvailabilityType[] getIt_Htl_Availability() {
        com.kcdata.abe.bapi.util.Yst_Ota_Htl_AvailabilityType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_Htl_AvailabilityType_List)baseTypeData().getElementValue(10);
    ...
    public com.kcdata.abe.bapi.util.Yst_Ota_Htl_Room_PricingType_List get_as_listIt_Htl_Pricing() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_Htl_Room_PricingType_List)baseTypeData().getElementValue(7);
    }

    public com.kcdata.abe.bapi.util.Yst_Ota_RoomstaycandidatesType_List get_as_listIt_Htl_Roomstaycandidates() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_RoomstaycandidatesType_List)baseTypeData().getElementValue(4);
    }
    ...
    public com.kcdata.abe.bapi.util.Yst_Ota_Htl_AvailabilityType_List get_as_listIt_Htl_Availability() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_Htl_AvailabilityType_List)baseTypeData().getElementValue(10);
    }

    public com.kcdata.abe.bapi.Yst_Ota_Htl_InfoType[] getIt_Htl_Info() {
        com.kcdata.abe.bapi.util.Yst_Ota_Htl_InfoType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_Htl_InfoType_List)baseTypeData().getElementValue(8);
        if ( i$ == null){return null;}
    ...
    public void setIt_Htl_Availability(com.kcdata.abe.bapi.util.Yst_Ota_Htl_AvailabilityType_List It_Htl_Availability) {
        baseTypeData().setElementValue(10, It_Htl_Availability);
    }

    public com.kcdata.abe.bapi.Yst_Ota_Htl_Room_PricingType[] getIt_Htl_Pricing() {
        com.kcdata.abe.bapi.util.Yst_Ota_Htl_Room_PricingType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_Htl_Room_PricingType_List)baseTypeData().getElementValue(7);
        if ( i$ == null){return null;}
    ...
    public com.kcdata.abe.bapi.util.Yst_Ota_Htl_Req_AmenityType_List get_as_listIt_Htl_Req_Amenity() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_Htl_Req_AmenityType_List)baseTypeData().getElementValue(5);
    }

    public void setIt_Htl_Pricing(com.kcdata.abe.bapi.Yst_Ota_Htl_Room_PricingType[] It_Htl_Pricing) {
        baseTypeData().setElementValue(7, new com.kcdata.abe.bapi.util.Yst_Ota_Htl_Room_PricingType_List());
    ...
    public void setIt_Htl_Info(com.kcdata.abe.bapi.Yst_Ota_Htl_InfoType[] It_Htl_Info) {
        baseTypeData().setElementValue(8, new com.kcdata.abe.bapi.util.Yst_Ota_Htl_InfoType_List());
    ...
    public com.kcdata.abe.bapi.util.Yst_Ota_Request_OptType_List get_as_listIt_Request_Opt() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_Request_OptType_List)baseTypeData().getElementValue(2);
    }

    public void setIt_Htl_Info(com.kcdata.abe.bapi.util.Yst_Ota_Htl_InfoType_List It_Htl_Info) {
        baseTypeData().setElementValue(8, It_Htl_Info);
    }
    ...
    public void setIt_Htl_Vend_Services(com.kcdata.abe.bapi.Yst_Ota_Htl_Vend_ServicesType[] It_Htl_Vend_Services) {
        baseTypeData().setElementValue(3, new com.kcdata.abe.bapi.util.Yst_Ota_Htl_Vend_ServicesType_List());
    ...
    public void setIt_Htl_Req_Amenity(com.kcdata.abe.bapi.Yst_Ota_Htl_Req_AmenityType[] It_Htl_Req_Amenity) {
        baseTypeData().setElementValue(5, new com.kcdata.abe.bapi.util.Yst_Ota_Htl_Req_AmenityType_List());
    ...
    public com.kcdata.abe.bapi.util.Yst_Ota_Htl_ReqType_List get_as_listIt_Htl_Req() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_Htl_ReqType_List)baseTypeData().getElementValue(6);
    }

    public void setIt_Htl_Amenity(com.kcdata.abe.bapi.Yst_Ota_Htl_AmenityType[] It_Htl_Amenity) {
        baseTypeData().setElementValue(11, new com.kcdata.abe.bapi.util.Yst_Ota_Htl_AmenityType_List());
    ...
    public com.kcdata.abe.bapi.util.Yst_Ota_Htl_Dest_ServicesType_List get_as_listIt_Htl_Dest_Services() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_Htl_Dest_ServicesType_List)baseTypeData().getElementValue(9);
    }

    public com.kcdata.abe.bapi.util.Yst_Ota_Htl_AmenityType_List get_as_listIt_Htl_Amenity() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_Htl_AmenityType_List)baseTypeData().getElementValue(11);
    }

    public void setIt_Htl_Dest_Services(com.kcdata.abe.bapi.Yst_Ota_Htl_Dest_ServicesType[] It_Htl_Dest_Services) {
        baseTypeData().setElementValue(9, new com.kcdata.abe.bapi.util.Yst_Ota_Htl_Dest_ServicesType_List());
    ...
    public com.kcdata.abe.bapi.util.Yst_Ota_Htl_Vend_ServicesType_List get_as_listIt_Htl_Vend_Services() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_Htl_Vend_ServicesType_List)baseTypeData().getElementValue(3);
    }

    public com.kcdata.abe.bapi.Yst_Ota_Request_OptType[] getIt_Request_Opt() {
        com.kcdata.abe.bapi.util.Yst_Ota_Request_OptType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_Request_OptType_List)baseTypeData().getElementValue(2);
        if ( i$ == null){return null;}
        return  i$.toArrayYst_Ota_Request_OptType();
    }

    public MetaData metadataY_Ota_Hotel_Availability_Output() {
        return metadata;
    }

    public void setIt_Htl_Availability(com.kcdata.abe.bapi.Yst_Ota_Htl_AvailabilityType[] It_Htl_Availability) {
        baseTypeData().setElementValue(10, new com.kcdata.abe.bapi.util.Yst_Ota_Htl_AvailabilityType_List());
    ...
    public void setIt_Htl_Req(com.kcdata.abe.bapi.Yst_Ota_Htl_ReqType[] It_Htl_Req) {
        baseTypeData().setElementValue(6, new com.kcdata.abe.bapi.util.Yst_Ota_Htl_ReqType_List());
    ...
    public com.kcdata.abe.bapi.Yst_Ota_RoomstaycandidatesType[] getIt_Htl_Roomstaycandidates() {
        com.kcdata.abe.bapi.util.Yst_Ota_RoomstaycandidatesType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_RoomstaycandidatesType_List)baseTypeData().getElementValue(4);
        if ( i$ == null){return null;}
        return  i$.toArrayYst_Ota_RoomstaycandidatesType();
    }

    public com.kcdata.abe.bapi.Yst_Ota_Htl_ReqType[] getIt_Htl_Req() {
        com.kcdata.abe.bapi.util.Yst_Ota_Htl_ReqType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_Htl_ReqType_List)baseTypeData().getElementValue(6);
        if ( i$ == null){return null;}
    ...
    public void setIt_Htl_Roomstaycandidates(com.kcdata.abe.bapi.Yst_Ota_RoomstaycandidatesType[] It_Htl_Roomstaycandidates) {
        baseTypeData().setElementValue(4, new com.kcdata.abe.bapi.util.Yst_Ota_RoomstaycandidatesType_List());
    ...
    public com.kcdata.abe.bapi.Yst_Ota_Htl_Dest_ServicesType[] getIt_Htl_Dest_Services() {
        com.kcdata.abe.bapi.util.Yst_Ota_Htl_Dest_ServicesType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_Htl_Dest_ServicesType_List)baseTypeData().getElementValue(9);
        if ( i$ == null){return null;}
    ...
    public void setIt_Htl_Roomstaycandidates(com.kcdata.abe.bapi.util.Yst_Ota_RoomstaycandidatesType_List It_Htl_Roomstaycandidates) {
        baseTypeData().setElementValue(4, It_Htl_Roomstaycandidates);
    }

    public com.kcdata.abe.bapi.Yst_Ota_Htl_AmenityType[] getIt_Htl_Amenity() {
        com.kcdata.abe.bapi.util.Yst_Ota_Htl_AmenityType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_Htl_AmenityType_List)baseTypeData().getElementValue(11);
        if ( i$ == null){return null;}
    ...
    public com.kcdata.abe.bapi.Yst_Ota_Htl_Vend_ServicesType[] getIt_Htl_Vend_Services() {
        com.kcdata.abe.bapi.util.Yst_Ota_Htl_Vend_ServicesType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_Htl_Vend_ServicesType_List)baseTypeData().getElementValue(3);
        if ( i$ == null){return null;}
    ...
    public static class MetaData implements java.io.Serializable {
        ...
        private  Y_Ota_Hotel_Availability_Output parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (Y_Ota_Hotel_Availability_Output parent) {
            this.parent = parent;
