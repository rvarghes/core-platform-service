...
public class Y_Bapi_Sked_Adv_Search_Details_Output extends com.sap.aii.proxy.framework.core.AbstractType{
    ...
    public void setIt_Bapi_Stopover_Info(com.kcdata.abe.bapi.util.Yst_Bapi_Stopover_InfoType_List It_Bapi_Stopover_Info) {
        baseTypeData().setElementValue(3, It_Bapi_Stopover_Info);
    }

    public void setIt_Bapi_Carrinfo(com.kcdata.abe.bapi.Yst_Bapi_Carri_InfoType[] It_Bapi_Carrinfo) {
        baseTypeData().setElementValue(4, new com.kcdata.abe.bapi.util.Yst_Bapi_Carri_InfoType_List());
    ...
    public com.kcdata.abe.bapi.Yst_Bapi_Carri_InfoType[] getIt_Bapi_Carrinfo() {
        com.kcdata.abe.bapi.util.Yst_Bapi_Carri_InfoType_List i$ = (com.kcdata.abe.bapi.util.Yst_Bapi_Carri_InfoType_List)baseTypeData().getElementValue(4);
    ...
    public void setIt_Bapi_Carrinfo(com.kcdata.abe.bapi.util.Yst_Bapi_Carri_InfoType_List It_Bapi_Carrinfo) {
        baseTypeData().setElementValue(4, It_Bapi_Carrinfo);
    }
    ...
    public com.kcdata.abe.bapi.util.Yst_Bapi_Carri_InfoType_List get_as_listIt_Bapi_Carrinfo() {
        return (com.kcdata.abe.bapi.util.Yst_Bapi_Carri_InfoType_List)baseTypeData().getElementValue(4);
    }

    public void setIt_Select_Para(com.kcdata.abe.bapi.util.Yst_Air_SelectionType_List It_Select_Para) {
        baseTypeData().setElementValue(1, It_Select_Para);
    }

    public com.kcdata.abe.bapi.Yst_Air_SelectionType[] getIt_Select_Para() {
        com.kcdata.abe.bapi.util.Yst_Air_SelectionType_List i$ = (com.kcdata.abe.bapi.util.Yst_Air_SelectionType_List)baseTypeData().getElementValue(1);
        if ( i$ == null){return null;}
    ...
    public void setIt_Select_Para(com.kcdata.abe.bapi.Yst_Air_SelectionType[] It_Select_Para) {
        baseTypeData().setElementValue(1, new com.kcdata.abe.bapi.util.Yst_Air_SelectionType_List());
    ...
    public com.kcdata.abe.bapi.Yst_Bapi_Stopover_InfoType[] getIt_Bapi_Stopover_Info() {
        com.kcdata.abe.bapi.util.Yst_Bapi_Stopover_InfoType_List i$ = (com.kcdata.abe.bapi.util.Yst_Bapi_Stopover_InfoType_List)baseTypeData().getElementValue(3);
        if ( i$ == null){return null;}
    ...
    public com.kcdata.abe.bapi.util.Yst_Bapi_Stopover_InfoType_List get_as_listIt_Bapi_Stopover_Info() {
        return (com.kcdata.abe.bapi.util.Yst_Bapi_Stopover_InfoType_List)baseTypeData().getElementValue(3);
    }

    public com.kcdata.abe.bapi.util.Yst_Air_SelectionType_List get_as_listIt_Select_Para() {
        return (com.kcdata.abe.bapi.util.Yst_Air_SelectionType_List)baseTypeData().getElementValue(1);
    }
    ...
    public void setIt_Bapi_Stopover_Info(com.kcdata.abe.bapi.Yst_Bapi_Stopover_InfoType[] It_Bapi_Stopover_Info) {
        baseTypeData().setElementValue(3, new com.kcdata.abe.bapi.util.Yst_Bapi_Stopover_InfoType_List());
    ...
    public MetaData metadataY_Bapi_Sked_Adv_Search_Details_Output() {
        return metadata;
    }
    ...
    public static class MetaData implements java.io.Serializable {
        ...
        private  Y_Bapi_Sked_Adv_Search_Details_Output parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (Y_Bapi_Sked_Adv_Search_Details_Output parent) {
            this.parent = parent;
