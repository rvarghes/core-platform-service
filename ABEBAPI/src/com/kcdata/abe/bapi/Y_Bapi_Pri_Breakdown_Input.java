...
public class Y_Bapi_Pri_Breakdown_Input extends com.sap.aii.proxy.framework.core.AbstractType{
    ...
    public void setCommissiondtls(com.kcdata.abe.bapi.util.Zapi_Commission_DtlsType_List Commissiondtls) {
        baseTypeData().setElementValue(5, Commissiondtls);
    }

    public void setCommissiondtls(com.kcdata.abe.bapi.Zapi_Commission_DtlsType[] Commissiondtls) {
        baseTypeData().setElementValue(5, new com.kcdata.abe.bapi.util.Zapi_Commission_DtlsType_List());
    ...
    public void setHeaderprices(com.kcdata.abe.bapi.util.Zapi_Pax_InfoType_List Headerprices) {
        baseTypeData().setElementValue(3, Headerprices);
    }

    public com.kcdata.abe.bapi.Zapi_Commission_DtlsType[] getCommissiondtls() {
        com.kcdata.abe.bapi.util.Zapi_Commission_DtlsType_List i$ = (com.kcdata.abe.bapi.util.Zapi_Commission_DtlsType_List)baseTypeData().getElementValue(5);
        if ( i$ == null){return null;}
        return  i$.toArrayZapi_Commission_DtlsType();
    }

    public com.kcdata.abe.bapi.Zapi_Pax_Info_DetailType[] getDetailprices() {
        com.kcdata.abe.bapi.util.Zapi_Pax_Info_DetailType_List i$ = (com.kcdata.abe.bapi.util.Zapi_Pax_Info_DetailType_List)baseTypeData().getElementValue(4);
        if ( i$ == null){return null;}
    ...
    public void setMaterial_Price(com.kcdata.abe.bapi.Zapi_Matl_PriceType[] Material_Price) {
        baseTypeData().setElementValue(2, new com.kcdata.abe.bapi.util.Zapi_Matl_PriceType_List());
    ...
    public void setDetailprices(com.kcdata.abe.bapi.Zapi_Pax_Info_DetailType[] Detailprices) {
        baseTypeData().setElementValue(4, new com.kcdata.abe.bapi.util.Zapi_Pax_Info_DetailType_List());
    ...
    public MetaData metadataY_Bapi_Pri_Breakdown_Input() {
        return metadata;
    }
    ...
    public static class MetaData implements java.io.Serializable {
        ...
        private  Y_Bapi_Pri_Breakdown_Input parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (Y_Bapi_Pri_Breakdown_Input parent) {
            this.parent = parent;
