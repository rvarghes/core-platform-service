...
public class Y_Ota_Retrieve_Quote_Output extends com.sap.aii.proxy.framework.core.AbstractType{
    ...
    public void setIt_Pax_Pricing(com.kcdata.abe.bapi.Yst_Ota_Pax_PricingType[] It_Pax_Pricing) {
        baseTypeData().setElementValue(5, new com.kcdata.abe.bapi.util.Yst_Ota_Pax_PricingType_List());
    ...
    public void setIt_Flt_Items(com.kcdata.abe.bapi.Yst_Ota_Flt_ItemsType[] It_Flt_Items) {
        baseTypeData().setElementValue(11, new com.kcdata.abe.bapi.util.Yst_Ota_Flt_ItemsType_List());
    ...
    public com.kcdata.abe.bapi.util.Yst_Ota_Pax_PricingType_List get_as_listIt_Pax_Pricing() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_Pax_PricingType_List)baseTypeData().getElementValue(5);
    }

    public void setIt_Flt_Items(com.kcdata.abe.bapi.util.Yst_Ota_Flt_ItemsType_List It_Flt_Items) {
        baseTypeData().setElementValue(11, It_Flt_Items);
    }

    public void setIt_Charges(com.kcdata.abe.bapi.util.Yst_Ota_ChargesType_List It_Charges) {
        baseTypeData().setElementValue(12, It_Charges);
    }

    public com.kcdata.abe.bapi.util.Yst_Ota_GuestinfoType_List get_as_listIt_Guestinfo() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_GuestinfoType_List)baseTypeData().getElementValue(9);
    }

    public MetaData metadataY_Ota_Retrieve_Quote_Output() {
        return metadata;
    }

    public com.kcdata.abe.bapi.Yst_Ota_Flt_SegmentsType[] getIt_Flt_Segments() {
        com.kcdata.abe.bapi.util.Yst_Ota_Flt_SegmentsType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_Flt_SegmentsType_List)baseTypeData().getElementValue(10);
        if ( i$ == null){return null;}
    ...
    public com.kcdata.abe.bapi.util.Yst_Bapi_Ins_ItemsType_List get_as_listIt_Ins_Items() {
        return (com.kcdata.abe.bapi.util.Yst_Bapi_Ins_ItemsType_List)baseTypeData().getElementValue(6);
    }

    public com.kcdata.abe.bapi.util.Yst_Ota_Flt_ItemsType_List get_as_listIt_Flt_Items() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_Flt_ItemsType_List)baseTypeData().getElementValue(11);
    }

    public void setIt_Pax_Pricing(com.kcdata.abe.bapi.util.Yst_Ota_Pax_PricingType_List It_Pax_Pricing) {
        baseTypeData().setElementValue(5, It_Pax_Pricing);
    }
    ...
    public void setIt_Guestinfo(com.kcdata.abe.bapi.Yst_Ota_GuestinfoType[] It_Guestinfo) {
        baseTypeData().setElementValue(9, new com.kcdata.abe.bapi.util.Yst_Ota_GuestinfoType_List());
    ...
    public void setIt_Ins_Items(com.kcdata.abe.bapi.util.Yst_Bapi_Ins_ItemsType_List It_Ins_Items) {
        baseTypeData().setElementValue(6, It_Ins_Items);
    }

    public com.kcdata.abe.bapi.Yst_Ota_Ser_ItemsType[] getIt_Ser_Items() {
        com.kcdata.abe.bapi.util.Yst_Ota_Ser_ItemsType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_Ser_ItemsType_List)baseTypeData().getElementValue(3);
        if ( i$ == null){return null;}
        return  i$.toArrayYst_Ota_Ser_ItemsType();
    }

    public com.kcdata.abe.bapi.Yst_Ota_Htl_ItemsType[] getIt_Htl_Items() {
        com.kcdata.abe.bapi.util.Yst_Ota_Htl_ItemsType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_Htl_ItemsType_List)baseTypeData().getElementValue(8);
        if ( i$ == null){return null;}
    ...
    public void setIt_Flt_Segments(com.kcdata.abe.bapi.Yst_Ota_Flt_SegmentsType[] It_Flt_Segments) {
        baseTypeData().setElementValue(10, new com.kcdata.abe.bapi.util.Yst_Ota_Flt_SegmentsType_List());
    ...
    public com.kcdata.abe.bapi.Yst_Ota_ChargesType[] getIt_Charges() {
        com.kcdata.abe.bapi.util.Yst_Ota_ChargesType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_ChargesType_List)baseTypeData().getElementValue(12);
        if ( i$ == null){return null;}
    ...
    public com.kcdata.abe.bapi.Yst_Ota_Pax_PricingType[] getIt_Pax_Pricing() {
        com.kcdata.abe.bapi.util.Yst_Ota_Pax_PricingType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_Pax_PricingType_List)baseTypeData().getElementValue(5);
        if ( i$ == null){return null;}
    ...
    public com.kcdata.abe.bapi.Yst_Ota_GuestinfoType[] getIt_Guestinfo() {
        com.kcdata.abe.bapi.util.Yst_Ota_GuestinfoType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_GuestinfoType_List)baseTypeData().getElementValue(9);
        if ( i$ == null){return null;}
        return  i$.toArrayYst_Ota_GuestinfoType();
    }

    public void setIt_Ins_Items(com.kcdata.abe.bapi.Yst_Bapi_Ins_ItemsType[] It_Ins_Items) {
        baseTypeData().setElementValue(6, new com.kcdata.abe.bapi.util.Yst_Bapi_Ins_ItemsType_List());
    ...
    public com.kcdata.abe.bapi.util.Yst_Ota_Flt_SegmentsType_List get_as_listIt_Flt_Segments() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_Flt_SegmentsType_List)baseTypeData().getElementValue(10);
    }
    ...
    public void setIt_Charges(com.kcdata.abe.bapi.Yst_Ota_ChargesType[] It_Charges) {
        baseTypeData().setElementValue(12, new com.kcdata.abe.bapi.util.Yst_Ota_ChargesType_List());
    ...
    public void setIt_Ser_Items(com.kcdata.abe.bapi.Yst_Ota_Ser_ItemsType[] It_Ser_Items) {
        baseTypeData().setElementValue(3, new com.kcdata.abe.bapi.util.Yst_Ota_Ser_ItemsType_List());
    ...
    public void setIt_Htl_Items(com.kcdata.abe.bapi.Yst_Ota_Htl_ItemsType[] It_Htl_Items) {
        baseTypeData().setElementValue(8, new com.kcdata.abe.bapi.util.Yst_Ota_Htl_ItemsType_List());
    ...
    public void setIt_Guestinfo(com.kcdata.abe.bapi.util.Yst_Ota_GuestinfoType_List It_Guestinfo) {
        baseTypeData().setElementValue(9, It_Guestinfo);
    }

    public static class MetaData implements java.io.Serializable {
    
        private  Y_Ota_Retrieve_Quote_Output parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (Y_Ota_Retrieve_Quote_Output parent) {
            this.parent = parent;
