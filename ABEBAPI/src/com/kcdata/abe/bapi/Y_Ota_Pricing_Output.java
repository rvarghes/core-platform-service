...
public class Y_Ota_Pricing_Output extends com.sap.aii.proxy.framework.core.AbstractType{
    ...
    public com.kcdata.abe.bapi.Yst_Bapi_Ins_ItemsType[] getIt_Ins_Items() {
        com.kcdata.abe.bapi.util.Yst_Bapi_Ins_ItemsType_List i$ = (com.kcdata.abe.bapi.util.Yst_Bapi_Ins_ItemsType_List)baseTypeData().getElementValue(8);
        if ( i$ == null){return null;}
    ...
    public com.kcdata.abe.bapi.util.Yst_Ota_ChargesType_List get_as_listIt_Charges() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_ChargesType_List)baseTypeData().getElementValue(15);
    }

    public void setIt_Infotext(com.kcdata.abe.bapi.util.Yst_InfotextType_List It_Infotext) {
        baseTypeData().setElementValue(9, It_Infotext);
    }
    ...
    public void setIt_Charges(com.kcdata.abe.bapi.util.Yst_Ota_ChargesType_List It_Charges) {
        baseTypeData().setElementValue(15, It_Charges);
    }
    ...
    public MetaData metadataY_Ota_Pricing_Output() {
        return metadata;
    }
    ...
    public com.kcdata.abe.bapi.Yst_Ota_Items_Paxtype_PricingType[] getIt_Items_Paxtype_Pricing() {
        com.kcdata.abe.bapi.util.Yst_Ota_Items_Paxtype_PricingType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_Items_Paxtype_PricingType_List)baseTypeData().getElementValue(7);
        if ( i$ == null){return null;}
        return  i$.toArrayYst_Ota_Items_Paxtype_PricingType();
    }
    ...
    public com.kcdata.abe.bapi.util.Yst_Bapi_Ins_ItemsType_List get_as_listIt_Ins_Items() {
        return (com.kcdata.abe.bapi.util.Yst_Bapi_Ins_ItemsType_List)baseTypeData().getElementValue(8);
    }
    ...
    public void setIt_Items_Paxtype_Pricing(com.kcdata.abe.bapi.Yst_Ota_Items_Paxtype_PricingType[] It_Items_Paxtype_Pricing) {
        baseTypeData().setElementValue(7, new com.kcdata.abe.bapi.util.Yst_Ota_Items_Paxtype_PricingType_List());
        com.kcdata.abe.bapi.util.Yst_Ota_Items_Paxtype_PricingType_List list$ = get_as_listIt_Items_Paxtype_Pricing();
        for (int  i$ = 0; i$ < It_Items_Paxtype_Pricing.length; i$++){
         list$.addYst_Ota_Items_Paxtype_PricingType(It_Items_Paxtype_Pricing[ i$]);
        }
    }

    public com.kcdata.abe.bapi.util.Yst_InfotextType_List get_as_listIt_Infotext() {
        return (com.kcdata.abe.bapi.util.Yst_InfotextType_List)baseTypeData().getElementValue(9);
    }

    public void setIt_Ins_Items(com.kcdata.abe.bapi.util.Yst_Bapi_Ins_ItemsType_List It_Ins_Items) {
        baseTypeData().setElementValue(8, It_Ins_Items);
    }
    ...
    public com.kcdata.abe.bapi.Yst_Ota_ChargesType[] getIt_Charges() {
        com.kcdata.abe.bapi.util.Yst_Ota_ChargesType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_ChargesType_List)baseTypeData().getElementValue(15);
        if ( i$ == null){return null;}
    ...
    public void setIt_Items_Paxtype_Pricing(com.kcdata.abe.bapi.util.Yst_Ota_Items_Paxtype_PricingType_List It_Items_Paxtype_Pricing) {
        baseTypeData().setElementValue(7, It_Items_Paxtype_Pricing);
    }
    ...
    public com.kcdata.abe.bapi.util.Yst_Ota_Items_Paxtype_PricingType_List get_as_listIt_Items_Paxtype_Pricing() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_Items_Paxtype_PricingType_List)baseTypeData().getElementValue(7);
    }
    ...
    public void setIt_Ins_Items(com.kcdata.abe.bapi.Yst_Bapi_Ins_ItemsType[] It_Ins_Items) {
        baseTypeData().setElementValue(8, new com.kcdata.abe.bapi.util.Yst_Bapi_Ins_ItemsType_List());
    ...
    public void setIt_Infotext(com.kcdata.abe.bapi.Yst_InfotextType[] It_Infotext) {
        baseTypeData().setElementValue(9, new com.kcdata.abe.bapi.util.Yst_InfotextType_List());
    ...
    public void setIt_Charges(com.kcdata.abe.bapi.Yst_Ota_ChargesType[] It_Charges) {
        baseTypeData().setElementValue(15, new com.kcdata.abe.bapi.util.Yst_Ota_ChargesType_List());
    ...
    public static class MetaData implements java.io.Serializable {
        ...
        private  Y_Ota_Pricing_Output parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (Y_Ota_Pricing_Output parent) {
            this.parent = parent;
        ...
        public com.sap.aii.proxy.framework.core.JcoMetaData getIt_Items_Paxtype_Pricing() {
