...
public class Y_Bapi_Get_Amenity_Codes_Names_Output extends com.sap.aii.proxy.framework.core.AbstractType{
    ...
    public void setIt_Htl_Amenity(com.kcdata.abe.bapi.Yst_Bapi_Amenity_CodesType[] It_Htl_Amenity) {
        baseTypeData().setElementValue(2, new com.kcdata.abe.bapi.util.Yst_Bapi_Amenity_CodesType_List());
    ...
    public com.kcdata.abe.bapi.Yst_Bapi_Amenity_CodesType[] getIt_Htl_Amenity() {
        com.kcdata.abe.bapi.util.Yst_Bapi_Amenity_CodesType_List i$ = (com.kcdata.abe.bapi.util.Yst_Bapi_Amenity_CodesType_List)baseTypeData().getElementValue(2);
    ...
    public com.kcdata.abe.bapi.util.Yst_Bapi_Amenity_CodesType_List get_as_listIt_Htl_Amenity() {
        return (com.kcdata.abe.bapi.util.Yst_Bapi_Amenity_CodesType_List)baseTypeData().getElementValue(2);
    }

    public MetaData metadataY_Bapi_Get_Amenity_Codes_Names_Output() {
        return metadata;
    }
    ...
    public void setIt_Htl_Amenity(com.kcdata.abe.bapi.util.Yst_Bapi_Amenity_CodesType_List It_Htl_Amenity) {
        baseTypeData().setElementValue(2, It_Htl_Amenity);
    }
    ...
    public static class MetaData implements java.io.Serializable {
        ...
        private  Y_Bapi_Get_Amenity_Codes_Names_Output parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (Y_Bapi_Get_Amenity_Codes_Names_Output parent) {
            this.parent = parent;
