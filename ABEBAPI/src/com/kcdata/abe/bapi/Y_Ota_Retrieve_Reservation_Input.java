...
public class Y_Ota_Retrieve_Reservation_Input extends com.sap.aii.proxy.framework.core.AbstractType{
    ...
    protected  Y_Ota_Retrieve_Reservation_Input (com.sap.aii.proxy.framework.core.BaseTypeDescriptor descriptor, com.sap.aii.proxy.framework.core.GenerationInfo staticGenerationInfo, int connectionType) {
        super(descriptor, staticGenerationInfo, connectionType);
    }

    public  Y_Ota_Retrieve_Reservation_Input () {
        super(staticDescriptor, staticGenerationInfo, com.sap.aii.proxy.framework.core.FactoryConstants.CONNECTION_TYPE_JCO);
        
    }

    public void setIt_Res_Flights(com.kcdata.abe.bapi.Yst_Ota_Res_FlightsType[] It_Res_Flights) {
        baseTypeData().setElementValue(10, new com.kcdata.abe.bapi.util.Yst_Ota_Res_FlightsType_List());
    ...
    public void setIt_Vendor_Info(com.kcdata.abe.bapi.util.Zapi_VendaddrType_List It_Vendor_Info) {
        baseTypeData().setElementValue(3, It_Vendor_Info);
    }

    public void setIt_Guestinfo(com.kcdata.abe.bapi.Yst_Ota_Res_GuestinfoType[] It_Guestinfo) {
        baseTypeData().setElementValue(12, new com.kcdata.abe.bapi.util.Yst_Ota_Res_GuestinfoType_List());
    ...
    public void setIt_Flight_Segments(com.kcdata.abe.bapi.util.Yst_Ota_Flt_SegmentsType_List It_Flight_Segments) {
        baseTypeData().setElementValue(13, It_Flight_Segments);
    }
    ...
    public MetaData metadataY_Ota_Retrieve_Reservation_Input() {
        return metadata;
    }
    ...
    public void setIt_Res_Ins(com.kcdata.abe.bapi.util.Yst_Bapi_Res_InsType_List It_Res_Ins) {
        baseTypeData().setElementValue(8, It_Res_Ins);
    }

    public void setIt_Seatmap(com.kcdata.abe.bapi.Yzseat_Info_SType[] It_Seatmap) {
        baseTypeData().setElementValue(4, new com.kcdata.abe.bapi.util.Yzseat_Info_SType_List());
    ...
    public com.kcdata.abe.bapi.util.Yzseat_Info_SType_List get_as_listIt_Seatmap() {
        return (com.kcdata.abe.bapi.util.Yzseat_Info_SType_List)baseTypeData().getElementValue(4);
    }

    public void setIt_Pax_Pricing(com.kcdata.abe.bapi.Yst_Ota_Pax_PricingType[] It_Pax_Pricing) {
        baseTypeData().setElementValue(11, new com.kcdata.abe.bapi.util.Yst_Ota_Pax_PricingType_List());
    ...
    public void setIt_Vendor_Info(com.kcdata.abe.bapi.Zapi_VendaddrType[] It_Vendor_Info) {
        baseTypeData().setElementValue(3, new com.kcdata.abe.bapi.util.Zapi_VendaddrType_List());
    ...
    public com.kcdata.abe.bapi.util.Yst_Bapi_Res_InsType_List get_as_listIt_Res_Ins() {
        return (com.kcdata.abe.bapi.util.Yst_Bapi_Res_InsType_List)baseTypeData().getElementValue(8);
    }
    ...
    public com.kcdata.abe.bapi.Yst_Ota_Res_VehType[] getIt_Res_Veh() {
        com.kcdata.abe.bapi.util.Yst_Ota_Res_VehType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_Res_VehType_List)baseTypeData().getElementValue(6);
    ...
    public com.kcdata.abe.bapi.util.Yst_Ota_Pax_PricingType_List get_as_listIt_Pax_Pricing() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_Pax_PricingType_List)baseTypeData().getElementValue(11);
    }

    public com.kcdata.abe.bapi.util.Yst_Ota_Res_GuestinfoType_List get_as_listIt_Guestinfo() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_Res_GuestinfoType_List)baseTypeData().getElementValue(12);
    }

    public com.kcdata.abe.bapi.util.Zapi_VendaddrType_List get_as_listIt_Vendor_Info() {
        return (com.kcdata.abe.bapi.util.Zapi_VendaddrType_List)baseTypeData().getElementValue(3);
    }

    public com.kcdata.abe.bapi.util.Yst_Ota_Res_FlightsType_List get_as_listIt_Res_Flights() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_Res_FlightsType_List)baseTypeData().getElementValue(10);
    }

    public com.kcdata.abe.bapi.util.Yst_Ota_Res_HotelsType_List get_as_listIt_Res_Hotels() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_Res_HotelsType_List)baseTypeData().getElementValue(9);
    }

    public void setIt_Res_Veh(com.kcdata.abe.bapi.Yst_Ota_Res_VehType[] It_Res_Veh) {
        baseTypeData().setElementValue(6, new com.kcdata.abe.bapi.util.Yst_Ota_Res_VehType_List());
    ...
    public com.kcdata.abe.bapi.Yst_Ota_Res_SerType[] getIt_Res_Ser() {
        com.kcdata.abe.bapi.util.Yst_Ota_Res_SerType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_Res_SerType_List)baseTypeData().getElementValue(7);
        if ( i$ == null){return null;}
        return  i$.toArrayYst_Ota_Res_SerType();
    }

    public void setIt_Res_Hotels(com.kcdata.abe.bapi.Yst_Ota_Res_HotelsType[] It_Res_Hotels) {
        baseTypeData().setElementValue(9, new com.kcdata.abe.bapi.util.Yst_Ota_Res_HotelsType_List());
    ...
    public void setIt_Res_Ser(com.kcdata.abe.bapi.Yst_Ota_Res_SerType[] It_Res_Ser) {
        baseTypeData().setElementValue(7, new com.kcdata.abe.bapi.util.Yst_Ota_Res_SerType_List());
    ...
    public void setIt_Res_Hotels(com.kcdata.abe.bapi.util.Yst_Ota_Res_HotelsType_List It_Res_Hotels) {
        baseTypeData().setElementValue(9, It_Res_Hotels);
    }
    ...
    public com.kcdata.abe.bapi.util.Yst_Ota_Res_VehType_List get_as_listIt_Res_Veh() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_Res_VehType_List)baseTypeData().getElementValue(6);
    }
    ...
    public void setIt_Res_Ser(com.kcdata.abe.bapi.util.Yst_Ota_Res_SerType_List It_Res_Ser) {
        baseTypeData().setElementValue(7, It_Res_Ser);
    }

    public com.kcdata.abe.bapi.Yst_Ota_Res_HotelsType[] getIt_Res_Hotels() {
        com.kcdata.abe.bapi.util.Yst_Ota_Res_HotelsType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_Res_HotelsType_List)baseTypeData().getElementValue(9);
        if ( i$ == null){return null;}
        return  i$.toArrayYst_Ota_Res_HotelsType();
    }

    public com.kcdata.abe.bapi.Yzseat_Info_SType[] getIt_Seatmap() {
        com.kcdata.abe.bapi.util.Yzseat_Info_SType_List i$ = (com.kcdata.abe.bapi.util.Yzseat_Info_SType_List)baseTypeData().getElementValue(4);
        if ( i$ == null){return null;}
    ...
    public com.kcdata.abe.bapi.Yst_Bapi_Res_InsType[] getIt_Res_Ins() {
        com.kcdata.abe.bapi.util.Yst_Bapi_Res_InsType_List i$ = (com.kcdata.abe.bapi.util.Yst_Bapi_Res_InsType_List)baseTypeData().getElementValue(8);
        if ( i$ == null){return null;}
    ...
    public com.kcdata.abe.bapi.Yst_Ota_Pax_PricingType[] getIt_Pax_Pricing() {
        com.kcdata.abe.bapi.util.Yst_Ota_Pax_PricingType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_Pax_PricingType_List)baseTypeData().getElementValue(11);
        if ( i$ == null){return null;}
        return  i$.toArrayYst_Ota_Pax_PricingType();
    }

    public com.kcdata.abe.bapi.util.Yst_Ota_Res_SerType_List get_as_listIt_Res_Ser() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_Res_SerType_List)baseTypeData().getElementValue(7);
    }

    public void setIt_Seatmap(com.kcdata.abe.bapi.util.Yzseat_Info_SType_List It_Seatmap) {
        baseTypeData().setElementValue(4, It_Seatmap);
    }

    public com.kcdata.abe.bapi.Yst_Ota_Res_GuestinfoType[] getIt_Guestinfo() {
        com.kcdata.abe.bapi.util.Yst_Ota_Res_GuestinfoType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_Res_GuestinfoType_List)baseTypeData().getElementValue(12);
        if ( i$ == null){return null;}
        return  i$.toArrayYst_Ota_Res_GuestinfoType();
    }

    public com.kcdata.abe.bapi.Zapi_VendaddrType[] getIt_Vendor_Info() {
        com.kcdata.abe.bapi.util.Zapi_VendaddrType_List i$ = (com.kcdata.abe.bapi.util.Zapi_VendaddrType_List)baseTypeData().getElementValue(3);
        if ( i$ == null){return null;}
        return  i$.toArrayZapi_VendaddrType();
    }

    public void setIt_Res_Ins(com.kcdata.abe.bapi.Yst_Bapi_Res_InsType[] It_Res_Ins) {
        baseTypeData().setElementValue(8, new com.kcdata.abe.bapi.util.Yst_Bapi_Res_InsType_List());
    ...
    public com.kcdata.abe.bapi.Yst_Ota_Res_FlightsType[] getIt_Res_Flights() {
        com.kcdata.abe.bapi.util.Yst_Ota_Res_FlightsType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_Res_FlightsType_List)baseTypeData().getElementValue(10);
        if ( i$ == null){return null;}
    ...
    public void setIt_Res_Flights(com.kcdata.abe.bapi.util.Yst_Ota_Res_FlightsType_List It_Res_Flights) {
        baseTypeData().setElementValue(10, It_Res_Flights);
    }
    ...
    public static class MetaData implements java.io.Serializable {
        ...
        private  Y_Ota_Retrieve_Reservation_Input parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (Y_Ota_Retrieve_Reservation_Input parent) {
            this.parent = parent;
