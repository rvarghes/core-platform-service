...
public class Y_Bapi_Get_Agency_Info_Output extends com.sap.aii.proxy.framework.core.AbstractType{
    ...
    private  Y_Bapi_Get_Agency_Info_Output.MetaData metadata = new MetaData(this) ;

    static {
        com.sap.aii.proxy.framework.core.BaseTypeDescriptor descriptor = createNewBaseTypeDescriptor(com.sap.aii.proxy.framework.core.XsdlConstants.WSDL_MESSAGE_FOR_JCO, "urn:sap-com:document:sap:rfc:functions", "Y_BAPI_GET_AGENCY_INFO.Output", 5, 0, com.kcdata.abe.bapi.Y_Bapi_Get_Agency_Info_Output.class, com.sap.aii.proxy.framework.core.FactoryConstants.CONNECTION_TYPE_JCO, "Y_BAPI_GET_AGENCY_INFO", 0, 0, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:container xmlns:ifr=\"urn:sap-com:ifr:v2:metamodel\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"><ifr:descriptor><ifr:description language=\"EN\">Get Agency Info</ifr:description></ifr:descriptor><ifr:properties><ifr:sourceSystem /><ifr:sourceClient>300</ifr:sourceClient><ifr:release>700 </ifr:release><ifr:package>YABE</ifr:package><ifr:akhNode>HLB0009075</ifr:akhNode><ifr:released>no</ifr:released><ifr:outbound>false</ifr:outbound><ifr:synchronous>true</ifr:synchronous><ifr:asynchronous>false</ifr:asynchronous><ifr:unicode1>true</ifr:unicode1><ifr:unicode2>true</ifr:unicode2></ifr:properties><ifr:definition /></ifr:container>");
        descriptorSetElementProperties(descriptor, 0, "EX_ST_AGENCY_HEADER", null, null, "unqualified", "urn:sap-com:document:sap:rfc:functions:YST_BAPI_AGENCY_HDR", "urn:sap-com:document:sap:rfc:functions", false, 0, 1, false, null, "Ex_St_Agency_Header", com.kcdata.abe.bapi.Yst_Bapi_Agency_HdrType.class, new com.kcdata.abe.bapi.Yst_Bapi_Agency_HdrType(), new java.lang.String[][]{}, "EX_ST_AGENCY_HEADER", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_STRUCTURE, com.sap.mw.jco.JCO.EXPORT_PARAMETER, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"EX_ST_AGENCY_HEADER\"><ifr:descriptor><ifr:description language=\"EN\">Agency Data</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"YST_BAPI_AGENCY_HDR\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=YST_BAPI_AGENCY_HDR\" /></ifr:definition><ifr:properties><ifr:direction>out</ifr:direction><ifr:class>export</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
    ...
    public  Y_Bapi_Get_Agency_Info_Output () {
        super(staticDescriptor, staticGenerationInfo, com.sap.aii.proxy.framework.core.FactoryConstants.CONNECTION_TYPE_JCO);
        
    }

    protected  Y_Bapi_Get_Agency_Info_Output (com.sap.aii.proxy.framework.core.BaseTypeDescriptor descriptor, com.sap.aii.proxy.framework.core.GenerationInfo staticGenerationInfo, int connectionType) {
    ...
    public com.kcdata.abe.bapi.Yst_Bapi_Agency_HdrType getEx_St_Agency_Header() {
        return (com.kcdata.abe.bapi.Yst_Bapi_Agency_HdrType)baseTypeData().getElementValue(0);
    }
    ...
    public void setEx_St_Agency_Header(com.kcdata.abe.bapi.Yst_Bapi_Agency_HdrType Ex_St_Agency_Header) {
        baseTypeData().setElementValue(0, Ex_St_Agency_Header);
    }

    public MetaData metadataY_Bapi_Get_Agency_Info_Output() {
        return metadata;
    }
    ...
    public static class MetaData implements java.io.Serializable {
        ...
        private  Y_Bapi_Get_Agency_Info_Output parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (Y_Bapi_Get_Agency_Info_Output parent) {
            this.parent = parent;
        ...
        public com.sap.aii.proxy.framework.core.JcoMetaData getEx_St_Agency_Header() {
