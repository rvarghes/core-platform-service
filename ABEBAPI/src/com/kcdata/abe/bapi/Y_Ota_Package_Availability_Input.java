...
public class Y_Ota_Package_Availability_Input extends com.sap.aii.proxy.framework.core.AbstractType{
    ...
    static {
        ...
        descriptorSetElementProperties(descriptor, 2, "IM_REQ_HDR", null, null, "unqualified", "urn:sap-com:document:sap:rfc:functions:YST_BAPI_REQ_PKG_HDR", "urn:sap-com:document:sap:rfc:functions", false, 1, 1, false, null, "Im_Req_Hdr", com.kcdata.abe.bapi.Yst_Bapi_Req_Pkg_HdrType.class, new com.kcdata.abe.bapi.Yst_Bapi_Req_Pkg_HdrType(), new java.lang.String[][]{}, "IM_REQ_HDR", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_STRUCTURE, com.sap.mw.jco.JCO.IMPORT_PARAMETER, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"IM_REQ_HDR\"><ifr:descriptor><ifr:description language=\"EN\">Package Request Header</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"YST_BAPI_REQ_PKG_HDR\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=YST_BAPI_REQ_PKG_HDR\" /></ifr:definition><ifr:properties><ifr:direction>in</ifr:direction><ifr:class>import</ifr:class><ifr:type>structure</ifr:type><ifr:optional>false</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 3, "IT_VEH_REQ", null, null, "unqualified", null, "urn:sap-com:document:sap:rfc:functions", false, 0, -1, false, null, "It_Veh_Req", com.kcdata.abe.bapi.util.Yst_Ota_Veh_ReqType_List.class, new com.kcdata.abe.bapi.Yst_Ota_Veh_ReqType(), new java.lang.String[][]{}, "IT_VEH_REQ", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_TABLE, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"IT_VEH_REQ\"><ifr:descriptor><ifr:description language=\"EN\">OTA Vehicle Request</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"YST_OTA_VEH_REQ\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=YST_OTA_VEH_REQ\" /></ifr:definition><ifr:properties><ifr:direction>inout</ifr:direction><ifr:class>tables</ifr:class><ifr:type>structure</ifr:type><ifr:optional>false</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
    ...
    public MetaData metadataY_Ota_Package_Availability_Input() {
        return metadata;
    }

    public com.kcdata.abe.bapi.util.Yst_Ota_Htl_Room_PricingType_List get_as_listIt_Htl_Pricing() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_Htl_Room_PricingType_List)baseTypeData().getElementValue(17);
    }
    ...
    public com.kcdata.abe.bapi.util.Yst_Ota_Htl_AvailabilityType_List get_as_listIt_Htl_Availability() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_Htl_AvailabilityType_List)baseTypeData().getElementValue(20);
    }

    public com.kcdata.abe.bapi.util.Yst_Ota_Htl_Req_AmenityType_List get_as_listIt_Htl_Req_Amenity() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_Htl_Req_AmenityType_List)baseTypeData().getElementValue(15);
    }
    ...
    public com.kcdata.abe.bapi.util.Yst_Ota_Veh_ReqType_List get_as_listIt_Veh_Req() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_Veh_ReqType_List)baseTypeData().getElementValue(3);
    }
    ...
    public void setIt_Ota_Flt_Orig_Dest(com.kcdata.abe.bapi.Yst_Ota_Flt_Orig_DestType[] It_Ota_Flt_Orig_Dest) {
        baseTypeData().setElementValue(12, new com.kcdata.abe.bapi.util.Yst_Ota_Flt_Orig_DestType_List());
    ...
    public void setIt_Sel_Htl_Items(com.kcdata.abe.bapi.util.Yst_Ota_Htl_ItemsType_List It_Sel_Htl_Items) {
        baseTypeData().setElementValue(6, It_Sel_Htl_Items);
    }
    ...
    public void setIm_Req_Hdr(com.kcdata.abe.bapi.Yst_Bapi_Req_Pkg_HdrType Im_Req_Hdr) {
    ...
    public void setIt_Htl_Info(com.kcdata.abe.bapi.util.Yst_Ota_Htl_InfoType_List It_Htl_Info) {
        baseTypeData().setElementValue(18, It_Htl_Info);
    }

    public void setIt_Veh_Req(com.kcdata.abe.bapi.Yst_Ota_Veh_ReqType[] It_Veh_Req) {
        baseTypeData().setElementValue(3, new com.kcdata.abe.bapi.util.Yst_Ota_Veh_ReqType_List());
    ...
    public com.kcdata.abe.bapi.util.Yst_Ota_Htl_ReqType_List get_as_listIt_Htl_Req() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_Htl_ReqType_List)baseTypeData().getElementValue(16);
    }

    public void setIt_Htl_Vend_Services(com.kcdata.abe.bapi.Yst_Ota_Htl_Vend_ServicesType[] It_Htl_Vend_Services) {
        baseTypeData().setElementValue(13, new com.kcdata.abe.bapi.util.Yst_Ota_Htl_Vend_ServicesType_List());
    ...
    public com.kcdata.abe.bapi.Yst_Ota_Flt_ItemsType[] getIt_Sel_Flt_Items() {
        com.kcdata.abe.bapi.util.Yst_Ota_Flt_ItemsType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_Flt_ItemsType_List)baseTypeData().getElementValue(8);
        if ( i$ == null){return null;}
    ...
    public com.kcdata.abe.bapi.util.Yst_Ota_Htl_Dest_ServicesType_List get_as_listIt_Htl_Dest_Services() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_Htl_Dest_ServicesType_List)baseTypeData().getElementValue(19);
    }

    public com.kcdata.abe.bapi.util.Yst_Ota_Htl_ItemsType_List get_as_listIt_Sel_Htl_Items() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_Htl_ItemsType_List)baseTypeData().getElementValue(6);
    }
    ...
    public void setIt_Htl_Dest_Services(com.kcdata.abe.bapi.Yst_Ota_Htl_Dest_ServicesType[] It_Htl_Dest_Services) {
        baseTypeData().setElementValue(19, new com.kcdata.abe.bapi.util.Yst_Ota_Htl_Dest_ServicesType_List());
    ...
    public com.kcdata.abe.bapi.Yst_Ota_Request_OptType[] getIt_Request_Opt() {
        com.kcdata.abe.bapi.util.Yst_Ota_Request_OptType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_Request_OptType_List)baseTypeData().getElementValue(10);
        if ( i$ == null){return null;}
    ...
    public void setIt_Sel_Htl_Items(com.kcdata.abe.bapi.Yst_Ota_Htl_ItemsType[] It_Sel_Htl_Items) {
        baseTypeData().setElementValue(6, new com.kcdata.abe.bapi.util.Yst_Ota_Htl_ItemsType_List());
    ...
    public void setIt_Htl_Req(com.kcdata.abe.bapi.Yst_Ota_Htl_ReqType[] It_Htl_Req) {
        baseTypeData().setElementValue(16, new com.kcdata.abe.bapi.util.Yst_Ota_Htl_ReqType_List());
    ...
    public void setIt_Sel_Veh_Items(com.kcdata.abe.bapi.util.Yst_Ota_Veh_ItemsType_List It_Sel_Veh_Items) {
        baseTypeData().setElementValue(5, It_Sel_Veh_Items);
    }
    ...
    public com.kcdata.abe.bapi.Yst_Ota_Htl_AmenityType[] getIt_Htl_Amenity() {
        com.kcdata.abe.bapi.util.Yst_Ota_Htl_AmenityType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_Htl_AmenityType_List)baseTypeData().getElementValue(21);
        if ( i$ == null){return null;}
    ...
    public void setIt_Htl_Amenity(com.kcdata.abe.bapi.util.Yst_Ota_Htl_AmenityType_List It_Htl_Amenity) {
        baseTypeData().setElementValue(21, It_Htl_Amenity);
    }

    public void setIt_Htl_Dest_Services(com.kcdata.abe.bapi.util.Yst_Ota_Htl_Dest_ServicesType_List It_Htl_Dest_Services) {
        baseTypeData().setElementValue(19, It_Htl_Dest_Services);
    }

    public com.kcdata.abe.bapi.Yst_Ota_Htl_Vend_ServicesType[] getIt_Htl_Vend_Services() {
        com.kcdata.abe.bapi.util.Yst_Ota_Htl_Vend_ServicesType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_Htl_Vend_ServicesType_List)baseTypeData().getElementValue(13);
        if ( i$ == null){return null;}
    ...
    public void setIt_Request_Opt(com.kcdata.abe.bapi.Yst_Ota_Request_OptType[] It_Request_Opt) {
        baseTypeData().setElementValue(10, new com.kcdata.abe.bapi.util.Yst_Ota_Request_OptType_List());
    ...
    public com.kcdata.abe.bapi.Yst_Ota_Htl_AvailabilityType[] getIt_Htl_Availability() {
        com.kcdata.abe.bapi.util.Yst_Ota_Htl_AvailabilityType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_Htl_AvailabilityType_List)baseTypeData().getElementValue(20);
        if ( i$ == null){return null;}
    ...
    public com.kcdata.abe.bapi.util.Yst_Ota_RoomstaycandidatesType_List get_as_listIt_Htl_Roomstaycandidates() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_RoomstaycandidatesType_List)baseTypeData().getElementValue(14);
    }

    public com.kcdata.abe.bapi.Yst_Bapi_Req_Pkg_HdrType getIm_Req_Hdr() {
        return (com.kcdata.abe.bapi.Yst_Bapi_Req_Pkg_HdrType)baseTypeData().getElementValue(2);
    }
    ...
    public com.kcdata.abe.bapi.Yst_Ota_Htl_InfoType[] getIt_Htl_Info() {
        com.kcdata.abe.bapi.util.Yst_Ota_Htl_InfoType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_Htl_InfoType_List)baseTypeData().getElementValue(18);
        if ( i$ == null){return null;}
    ...
    public void setIt_Htl_Availability(com.kcdata.abe.bapi.util.Yst_Ota_Htl_AvailabilityType_List It_Htl_Availability) {
        baseTypeData().setElementValue(20, It_Htl_Availability);
    }

    public com.kcdata.abe.bapi.Yst_Ota_Htl_Room_PricingType[] getIt_Htl_Pricing() {
        com.kcdata.abe.bapi.util.Yst_Ota_Htl_Room_PricingType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_Htl_Room_PricingType_List)baseTypeData().getElementValue(17);
        if ( i$ == null){return null;}
    ...
    public void setIt_Sel_Flt_Items(com.kcdata.abe.bapi.Yst_Ota_Flt_ItemsType[] It_Sel_Flt_Items) {
        baseTypeData().setElementValue(8, new com.kcdata.abe.bapi.util.Yst_Ota_Flt_ItemsType_List());
    ...
    public void setIt_Htl_Pricing(com.kcdata.abe.bapi.Yst_Ota_Htl_Room_PricingType[] It_Htl_Pricing) {
        baseTypeData().setElementValue(17, new com.kcdata.abe.bapi.util.Yst_Ota_Htl_Room_PricingType_List());
    ...
    public void setIt_Htl_Info(com.kcdata.abe.bapi.Yst_Ota_Htl_InfoType[] It_Htl_Info) {
        baseTypeData().setElementValue(18, new com.kcdata.abe.bapi.util.Yst_Ota_Htl_InfoType_List());
    ...
    public com.kcdata.abe.bapi.util.Yst_Ota_Flt_ItemsType_List get_as_listIt_Sel_Flt_Items() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_Flt_ItemsType_List)baseTypeData().getElementValue(8);
    }
    ...
    public com.kcdata.abe.bapi.util.Yst_Ota_Request_OptType_List get_as_listIt_Request_Opt() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_Request_OptType_List)baseTypeData().getElementValue(10);
    }
    ...
    public com.kcdata.abe.bapi.Yst_Ota_Flt_Orig_DestType[] getIt_Ota_Flt_Orig_Dest() {
        com.kcdata.abe.bapi.util.Yst_Ota_Flt_Orig_DestType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_Flt_Orig_DestType_List)baseTypeData().getElementValue(12);
        if ( i$ == null){return null;}
    ...
    public void setIt_Htl_Req_Amenity(com.kcdata.abe.bapi.Yst_Ota_Htl_Req_AmenityType[] It_Htl_Req_Amenity) {
        baseTypeData().setElementValue(15, new com.kcdata.abe.bapi.util.Yst_Ota_Htl_Req_AmenityType_List());
    ...
    public void setIt_Htl_Amenity(com.kcdata.abe.bapi.Yst_Ota_Htl_AmenityType[] It_Htl_Amenity) {
        baseTypeData().setElementValue(21, new com.kcdata.abe.bapi.util.Yst_Ota_Htl_AmenityType_List());
    ...
    public com.kcdata.abe.bapi.util.Yst_Ota_Htl_AmenityType_List get_as_listIt_Htl_Amenity() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_Htl_AmenityType_List)baseTypeData().getElementValue(21);
    }

    public com.kcdata.abe.bapi.util.Yst_Ota_Htl_Vend_ServicesType_List get_as_listIt_Htl_Vend_Services() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_Htl_Vend_ServicesType_List)baseTypeData().getElementValue(13);
    }
    ...
    public void setIt_Htl_Availability(com.kcdata.abe.bapi.Yst_Ota_Htl_AvailabilityType[] It_Htl_Availability) {
        baseTypeData().setElementValue(20, new com.kcdata.abe.bapi.util.Yst_Ota_Htl_AvailabilityType_List());
    ...
    public com.kcdata.abe.bapi.Yst_Ota_Htl_ReqType[] getIt_Htl_Req() {
        com.kcdata.abe.bapi.util.Yst_Ota_Htl_ReqType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_Htl_ReqType_List)baseTypeData().getElementValue(16);
        if ( i$ == null){return null;}
    ...
    public com.kcdata.abe.bapi.Yst_Ota_RoomstaycandidatesType[] getIt_Htl_Roomstaycandidates() {
        com.kcdata.abe.bapi.util.Yst_Ota_RoomstaycandidatesType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_RoomstaycandidatesType_List)baseTypeData().getElementValue(14);
        if ( i$ == null){return null;}
    ...
    public void setIt_Htl_Roomstaycandidates(com.kcdata.abe.bapi.Yst_Ota_RoomstaycandidatesType[] It_Htl_Roomstaycandidates) {
        baseTypeData().setElementValue(14, new com.kcdata.abe.bapi.util.Yst_Ota_RoomstaycandidatesType_List());
    ...
    public com.kcdata.abe.bapi.Yst_Ota_Htl_Dest_ServicesType[] getIt_Htl_Dest_Services() {
        com.kcdata.abe.bapi.util.Yst_Ota_Htl_Dest_ServicesType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_Htl_Dest_ServicesType_List)baseTypeData().getElementValue(19);
        if ( i$ == null){return null;}
        return  i$.toArrayYst_Ota_Htl_Dest_ServicesType();
    }

    public com.kcdata.abe.bapi.Yst_Ota_Htl_ItemsType[] getIt_Sel_Htl_Items() {
        com.kcdata.abe.bapi.util.Yst_Ota_Htl_ItemsType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_Htl_ItemsType_List)baseTypeData().getElementValue(6);
        if ( i$ == null){return null;}
    ...
    public void setIt_Htl_Roomstaycandidates(com.kcdata.abe.bapi.util.Yst_Ota_RoomstaycandidatesType_List It_Htl_Roomstaycandidates) {
        baseTypeData().setElementValue(14, It_Htl_Roomstaycandidates);
    }
    ...
    public void setIt_Veh_Req(com.kcdata.abe.bapi.util.Yst_Ota_Veh_ReqType_List It_Veh_Req) {
        baseTypeData().setElementValue(3, It_Veh_Req);
    }

    public static class MetaData implements java.io.Serializable {
    
        private  Y_Ota_Package_Availability_Input parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (Y_Ota_Package_Availability_Input parent) {
            this.parent = parent;
