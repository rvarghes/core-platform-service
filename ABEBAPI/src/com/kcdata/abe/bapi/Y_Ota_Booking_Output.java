...
public class Y_Ota_Booking_Output extends com.sap.aii.proxy.framework.core.AbstractType{

    private  static final com.sap.aii.proxy.framework.core.BaseTypeDescriptor staticDescriptor ;

    private  static final com.sap.aii.proxy.framework.core.GenerationInfo staticGenerationInfo = new com.sap.aii.proxy.framework.core.GenerationInfo("2.0", 1341668180228L) ;

    private  Y_Ota_Booking_Output.MetaData metadata = new MetaData(this) ;

    static {
        com.sap.aii.proxy.framework.core.BaseTypeDescriptor descriptor = createNewBaseTypeDescriptor(com.sap.aii.proxy.framework.core.XsdlConstants.WSDL_MESSAGE_FOR_JCO, "urn:sap-com:document:sap:rfc:functions", "Y_OTA_BOOKING.Output", 15, 0, com.kcdata.abe.bapi.Y_Ota_Booking_Output.class, com.sap.aii.proxy.framework.core.FactoryConstants.CONNECTION_TYPE_JCO, "Y_OTA_BOOKING", 0, 0, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:container xmlns:ifr=\"urn:sap-com:ifr:v2:metamodel\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"><ifr:descriptor><ifr:description language=\"EN\">Create Booking</ifr:description></ifr:descriptor><ifr:properties><ifr:sourceSystem /><ifr:sourceClient>300</ifr:sourceClient><ifr:release>700 </ifr:release><ifr:package>YABE</ifr:package><ifr:akhNode>HLB0009075</ifr:akhNode><ifr:released>no</ifr:released><ifr:outbound>false</ifr:outbound><ifr:synchronous>true</ifr:synchronous><ifr:asynchronous>false</ifr:asynchronous><ifr:unicode1>true</ifr:unicode1><ifr:unicode2>true</ifr:unicode2></ifr:properties><ifr:definition /></ifr:container>");
        ...
        descriptorSetElementProperties(descriptor, 1, "EX_ST_BOOKING_HDR", null, null, "unqualified", "urn:sap-com:document:sap:rfc:functions:YST_BAPI_BOOKING_HDR", "urn:sap-com:document:sap:rfc:functions", false, 0, 1, false, null, "Ex_St_Booking_Hdr", com.kcdata.abe.bapi.Yst_Bapi_Booking_HdrType.class, new com.kcdata.abe.bapi.Yst_Bapi_Booking_HdrType(), new java.lang.String[][]{}, "EX_ST_BOOKING_HDR", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_STRUCTURE, com.sap.mw.jco.JCO.EXPORT_PARAMETER, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"EX_ST_BOOKING_HDR\"><ifr:descriptor><ifr:description language=\"EN\">Sales Document</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"YST_BAPI_BOOKING_HDR\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=YST_BAPI_BOOKING_HDR\" /></ifr:definition><ifr:properties><ifr:direction>out</ifr:direction><ifr:class>export</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
    ...
    public com.kcdata.abe.bapi.util.Yzseat_Info_SType_List get_as_listIt_Seatmap() {
        return (com.kcdata.abe.bapi.util.Yzseat_Info_SType_List)baseTypeData().getElementValue(7);
    }

    public void setIt_Seatmap(com.kcdata.abe.bapi.Yzseat_Info_SType[] It_Seatmap) {
        baseTypeData().setElementValue(7, new com.kcdata.abe.bapi.util.Yzseat_Info_SType_List());
    ...
    public void setIt_Flt_Items(com.kcdata.abe.bapi.Yst_Ota_Flt_ItemsType[] It_Flt_Items) {
        baseTypeData().setElementValue(14, new com.kcdata.abe.bapi.util.Yst_Ota_Flt_ItemsType_List());
    ...
    public void setIt_Flt_Items(com.kcdata.abe.bapi.util.Yst_Ota_Flt_ItemsType_List It_Flt_Items) {
        baseTypeData().setElementValue(14, It_Flt_Items);
    }

    public com.kcdata.abe.bapi.util.Yst_Ota_GuestinfoType_List get_as_listIt_Guestinfo() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_GuestinfoType_List)baseTypeData().getElementValue(12);
    }

    public com.kcdata.abe.bapi.Yst_Ota_Flt_SegmentsType[] getIt_Flt_Segments() {
        com.kcdata.abe.bapi.util.Yst_Ota_Flt_SegmentsType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_Flt_SegmentsType_List)baseTypeData().getElementValue(13);
        if ( i$ == null){return null;}
    ...
    public void setIt_Trn_Items(com.kcdata.abe.bapi.Yst_Bapi_Trn_ItemsType[] It_Trn_Items) {
        baseTypeData().setElementValue(3, new com.kcdata.abe.bapi.util.Yst_Bapi_Trn_ItemsType_List());
    ...
    public MetaData metadataY_Ota_Booking_Output() {
        return metadata;
    }

    public com.kcdata.abe.bapi.util.Yst_Bapi_Trn_ItemsType_List get_as_listIt_Trn_Items() {
        return (com.kcdata.abe.bapi.util.Yst_Bapi_Trn_ItemsType_List)baseTypeData().getElementValue(3);
    }

    public com.kcdata.abe.bapi.util.Yst_Ota_Flt_ItemsType_List get_as_listIt_Flt_Items() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_Flt_ItemsType_List)baseTypeData().getElementValue(14);
    }

    public com.kcdata.abe.bapi.util.Yst_Bapi_Ins_ItemsType_List get_as_listIt_Ins_Items() {
        return (com.kcdata.abe.bapi.util.Yst_Bapi_Ins_ItemsType_List)baseTypeData().getElementValue(9);
    }

    public com.kcdata.abe.bapi.util.Yst_Ota_RoomstaycandidatesType_List get_as_listIt_Htl_Roomstaycandidates() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_RoomstaycandidatesType_List)baseTypeData().getElementValue(10);
    }

    public void setIt_Guestinfo(com.kcdata.abe.bapi.Yst_Ota_GuestinfoType[] It_Guestinfo) {
        baseTypeData().setElementValue(12, new com.kcdata.abe.bapi.util.Yst_Ota_GuestinfoType_List());
    ...
    public com.kcdata.abe.bapi.Yst_Bapi_Trn_GeninfoType[] getIt_Trn_Geninfo() {
        com.kcdata.abe.bapi.util.Yst_Bapi_Trn_GeninfoType_List i$ = (com.kcdata.abe.bapi.util.Yst_Bapi_Trn_GeninfoType_List)baseTypeData().getElementValue(5);
        if ( i$ == null){return null;}
    ...
    public void setIt_Trn_Items(com.kcdata.abe.bapi.util.Yst_Bapi_Trn_ItemsType_List It_Trn_Items) {
        baseTypeData().setElementValue(3, It_Trn_Items);
    }

    public com.kcdata.abe.bapi.Yst_Bapi_Trn_HdrType[] getIt_Trn_Hdr() {
        com.kcdata.abe.bapi.util.Yst_Bapi_Trn_HdrType_List i$ = (com.kcdata.abe.bapi.util.Yst_Bapi_Trn_HdrType_List)baseTypeData().getElementValue(4);
        if ( i$ == null){return null;}
        return  i$.toArrayYst_Bapi_Trn_HdrType();
    }

    public com.kcdata.abe.bapi.Yst_Bapi_Booking_HdrType getEx_St_Booking_Hdr() {
        return (com.kcdata.abe.bapi.Yst_Bapi_Booking_HdrType)baseTypeData().getElementValue(1);
    }

    public void setIt_Trn_Geninfo(com.kcdata.abe.bapi.util.Yst_Bapi_Trn_GeninfoType_List It_Trn_Geninfo) {
        baseTypeData().setElementValue(5, It_Trn_Geninfo);
    }

    public void setIt_Ins_Items(com.kcdata.abe.bapi.util.Yst_Bapi_Ins_ItemsType_List It_Ins_Items) {
        baseTypeData().setElementValue(9, It_Ins_Items);
    }

    public com.kcdata.abe.bapi.Yst_Ota_Ser_ItemsType[] getIt_Ser_Items() {
        com.kcdata.abe.bapi.util.Yst_Ota_Ser_ItemsType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_Ser_ItemsType_List)baseTypeData().getElementValue(6);
        if ( i$ == null){return null;}
        return  i$.toArrayYst_Ota_Ser_ItemsType();
    }

    public com.kcdata.abe.bapi.Yst_Ota_Htl_ItemsType[] getIt_Htl_Items() {
        com.kcdata.abe.bapi.util.Yst_Ota_Htl_ItemsType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_Htl_ItemsType_List)baseTypeData().getElementValue(11);
        if ( i$ == null){return null;}
    ...
    public void setIt_Flt_Segments(com.kcdata.abe.bapi.Yst_Ota_Flt_SegmentsType[] It_Flt_Segments) {
        baseTypeData().setElementValue(13, new com.kcdata.abe.bapi.util.Yst_Ota_Flt_SegmentsType_List());
    ...
    public void setIt_Ser_Items(com.kcdata.abe.bapi.util.Yst_Ota_Ser_ItemsType_List It_Ser_Items) {
        baseTypeData().setElementValue(6, It_Ser_Items);
    }

    public void setIt_Htl_Items(com.kcdata.abe.bapi.util.Yst_Ota_Htl_ItemsType_List It_Htl_Items) {
        baseTypeData().setElementValue(11, It_Htl_Items);
    }

    public com.kcdata.abe.bapi.Yzseat_Info_SType[] getIt_Seatmap() {
        com.kcdata.abe.bapi.util.Yzseat_Info_SType_List i$ = (com.kcdata.abe.bapi.util.Yzseat_Info_SType_List)baseTypeData().getElementValue(7);
        if ( i$ == null){return null;}
    ...
    public void setIt_Flt_Segments(com.kcdata.abe.bapi.util.Yst_Ota_Flt_SegmentsType_List It_Flt_Segments) {
        baseTypeData().setElementValue(13, It_Flt_Segments);
    }

    public void setIt_Trn_Hdr(com.kcdata.abe.bapi.util.Yst_Bapi_Trn_HdrType_List It_Trn_Hdr) {
        baseTypeData().setElementValue(4, It_Trn_Hdr);
    }
    ...
    public void setIt_Seatmap(com.kcdata.abe.bapi.util.Yzseat_Info_SType_List It_Seatmap) {
        baseTypeData().setElementValue(7, It_Seatmap);
    }

    public com.kcdata.abe.bapi.Yst_Ota_GuestinfoType[] getIt_Guestinfo() {
        com.kcdata.abe.bapi.util.Yst_Ota_GuestinfoType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_GuestinfoType_List)baseTypeData().getElementValue(12);
        if ( i$ == null){return null;}
    ...
    public void setIt_Trn_Geninfo(com.kcdata.abe.bapi.Yst_Bapi_Trn_GeninfoType[] It_Trn_Geninfo) {
        baseTypeData().setElementValue(5, new com.kcdata.abe.bapi.util.Yst_Bapi_Trn_GeninfoType_List());
    ...
    public void setIt_Trn_Hdr(com.kcdata.abe.bapi.Yst_Bapi_Trn_HdrType[] It_Trn_Hdr) {
        baseTypeData().setElementValue(4, new com.kcdata.abe.bapi.util.Yst_Bapi_Trn_HdrType_List());
    ...
    public void setIt_Ins_Items(com.kcdata.abe.bapi.Yst_Bapi_Ins_ItemsType[] It_Ins_Items) {
        baseTypeData().setElementValue(9, new com.kcdata.abe.bapi.util.Yst_Bapi_Ins_ItemsType_List());
    ...
    public com.kcdata.abe.bapi.util.Yst_Ota_Flt_SegmentsType_List get_as_listIt_Flt_Segments() {
        return (com.kcdata.abe.bapi.util.Yst_Ota_Flt_SegmentsType_List)baseTypeData().getElementValue(13);
    }

    public com.kcdata.abe.bapi.Yst_Ota_RoomstaycandidatesType[] getIt_Htl_Roomstaycandidates() {
        com.kcdata.abe.bapi.util.Yst_Ota_RoomstaycandidatesType_List i$ = (com.kcdata.abe.bapi.util.Yst_Ota_RoomstaycandidatesType_List)baseTypeData().getElementValue(10);
        if ( i$ == null){return null;}
    ...
    public void setIt_Htl_Roomstaycandidates(com.kcdata.abe.bapi.Yst_Ota_RoomstaycandidatesType[] It_Htl_Roomstaycandidates) {
        baseTypeData().setElementValue(10, new com.kcdata.abe.bapi.util.Yst_Ota_RoomstaycandidatesType_List());
    ...
    public void setIt_Ser_Items(com.kcdata.abe.bapi.Yst_Ota_Ser_ItemsType[] It_Ser_Items) {
        baseTypeData().setElementValue(6, new com.kcdata.abe.bapi.util.Yst_Ota_Ser_ItemsType_List());
    ...
    public com.kcdata.abe.bapi.util.Yst_Bapi_Trn_GeninfoType_List get_as_listIt_Trn_Geninfo() {
        return (com.kcdata.abe.bapi.util.Yst_Bapi_Trn_GeninfoType_List)baseTypeData().getElementValue(5);
    }
    ...
    public void setIt_Htl_Roomstaycandidates(com.kcdata.abe.bapi.util.Yst_Ota_RoomstaycandidatesType_List It_Htl_Roomstaycandidates) {
        baseTypeData().setElementValue(10, It_Htl_Roomstaycandidates);
    }

    public void setIt_Htl_Items(com.kcdata.abe.bapi.Yst_Ota_Htl_ItemsType[] It_Htl_Items) {
        baseTypeData().setElementValue(11, new com.kcdata.abe.bapi.util.Yst_Ota_Htl_ItemsType_List());
    ...
    public void setIt_Guestinfo(com.kcdata.abe.bapi.util.Yst_Ota_GuestinfoType_List It_Guestinfo) {
        baseTypeData().setElementValue(12, It_Guestinfo);
    }

    public static class MetaData implements java.io.Serializable {
    
        private  Y_Ota_Booking_Output parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (Y_Ota_Booking_Output parent) {
            this.parent = parent;
        ...
        public com.sap.aii.proxy.framework.core.JcoMetaData getEx_St_Booking_Hdr() {
