...
public class Y_Bapi_Htl_Farerules_Output extends com.sap.aii.proxy.framework.core.AbstractType{
    ...
    public  Y_Bapi_Htl_Farerules_Output () {
        super(staticDescriptor, staticGenerationInfo, com.sap.aii.proxy.framework.core.FactoryConstants.CONNECTION_TYPE_JCO);
        
    }

    protected  Y_Bapi_Htl_Farerules_Output (com.sap.aii.proxy.framework.core.BaseTypeDescriptor descriptor, com.sap.aii.proxy.framework.core.GenerationInfo staticGenerationInfo, int connectionType) {
    ...
    public com.kcdata.abe.bapi.Yst_Htl_Room_Code_CatType[] getIt_Htl_Rm_Code_Cat() {
        com.kcdata.abe.bapi.util.Yst_Htl_Room_Code_CatType_List i$ = (com.kcdata.abe.bapi.util.Yst_Htl_Room_Code_CatType_List)baseTypeData().getElementValue(2);
        if ( i$ == null){return null;}
    ...
    public void setIt_Htl_Rm_Code_Cat(com.kcdata.abe.bapi.util.Yst_Htl_Room_Code_CatType_List It_Htl_Rm_Code_Cat) {
        baseTypeData().setElementValue(2, It_Htl_Rm_Code_Cat);
    }

    public void setIt_Htl_Rm_Code_Cat(com.kcdata.abe.bapi.Yst_Htl_Room_Code_CatType[] It_Htl_Rm_Code_Cat) {
        baseTypeData().setElementValue(2, new com.kcdata.abe.bapi.util.Yst_Htl_Room_Code_CatType_List());
    ...
    public com.kcdata.abe.bapi.Yst_Htl_FarerulesType[] getIt_Farerules() {
        com.kcdata.abe.bapi.util.Yst_Htl_FarerulesType_List i$ = (com.kcdata.abe.bapi.util.Yst_Htl_FarerulesType_List)baseTypeData().getElementValue(3);
        if ( i$ == null){return null;}
    ...
    public MetaData metadataY_Bapi_Htl_Farerules_Output() {
        return metadata;
    }

    public void setIt_Farerules(com.kcdata.abe.bapi.Yst_Htl_FarerulesType[] It_Farerules) {
        baseTypeData().setElementValue(3, new com.kcdata.abe.bapi.util.Yst_Htl_FarerulesType_List());
    ...
    public com.kcdata.abe.bapi.util.Yst_Htl_FarerulesType_List get_as_listIt_Farerules() {
        return (com.kcdata.abe.bapi.util.Yst_Htl_FarerulesType_List)baseTypeData().getElementValue(3);
    }

    public com.kcdata.abe.bapi.util.Yst_Htl_Room_Code_CatType_List get_as_listIt_Htl_Rm_Code_Cat() {
        return (com.kcdata.abe.bapi.util.Yst_Htl_Room_Code_CatType_List)baseTypeData().getElementValue(2);
    }
    ...
    public static class MetaData implements java.io.Serializable {
        ...
        private  Y_Bapi_Htl_Farerules_Output parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (Y_Bapi_Htl_Farerules_Output parent) {
            this.parent = parent;
